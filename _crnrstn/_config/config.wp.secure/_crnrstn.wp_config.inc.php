...
switch($this->env_cleartext_name){
    ...
    case 'BLUEHOST_GITHUB':
        ...
        define( 'DB_NAME', 'jony5_alpha' );

        /** MySQL database username
        define( 'DB_USER', 'jony5_alpha' );

        /** MySQL database password
        define( 'DB_PASSWORD', 'GBhuLbDnj1dYQ2SR' );
        ...
        define( 'DB_COLLATE', '' );
        define('AUTH_KEY',         'l|L+@=|6 7%7v;;=Q/jJYT+Se @!q(u [0ltJ[veCdb<YPzK>|?zJx+t^2<H-8~|');
        define('SECURE_AUTH_KEY',  ' ++^]X:r%TBjRx1(:[E^3=bm}y+yWShNWQ?A(t7)+U-hKx??~w{0!~S*^]&#LL|3');
        define('LOGGED_IN_KEY',    'B8JD_D*]YOWF;JMz7uo3_buXjrb+;v+&#x.!VI$ i91+Gwl6C=%wn~&{# ZEB@Oy');
        define('NONCE_KEY',        'j-nbwnAKE,?Y8AF&Dgy-lW(]%z>dOOw$;5`-n6rdb4`<A#fka~zBWYVED~fi~?:k');
        define('AUTH_SALT',        'zDO x|b}Pw9u3Z)fk*B#w[?) 4gI-T`[tzgLDBMcd{Yd`MObkzWQyOAUrqn-Oe8m');
        define('SECURE_AUTH_SALT', 'AsODMnQ8LMPL%^P9T*=^3}iWP!E4@~5K)H5?{S2]r@36CI1VxJ]O%l1b]E^+m%$i');
        define('LOGGED_IN_SALT',   'g$B0)rZ=quXZFaI8.jef~Vob1Sl+Eo`LIFGPR wXirtv<lBT;D>j+|}-m_we`AJa');
        define('NONCE_SALT',       ')ZOS+k-a<S&?ZAr:J8n;r3 #|n;lpN#|(+=WxB#B10%B|%D-nTZ>Oe^?r$4rK][e');
        */
