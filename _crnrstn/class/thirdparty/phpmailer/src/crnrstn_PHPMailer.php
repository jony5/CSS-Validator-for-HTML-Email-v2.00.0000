...
class crnrstn_PHPMailer
{
     ...
     */
    public function __construct($oCRNRSTN_n, $exceptions = null)
    {
        self::$oCRNRSTN_n = $oCRNRSTN_n;

        $this->SMTPDebug = self::$oCRNRSTN_n->PHPMAILER_debugMode;
    ...
    protected function edebug($str, $line_num=NULL, $method=NULL, $file=NULL)
    {
        ...
        //
        // CRNRSTN v2.0.0 ERROR LOGGING SUPPORT
        self::$oCRNRSTN_n->error_log($str, $line_num, $method, $file, CRNRSTN_GABRIEL);
    ...
    public function getSMTPInstance()
    {
        if (!is_object($this->smtp)) {
            $this->smtp = new crnrstn_SMTP(self::$oCRNRSTN_n);
        }
