	<div data-role="header" data-position="fixed">
         <div style="float:left; padding:5px; padding-bottom:0px; margin:5px;">
            ...
            <!--<a href="#leftpanel_nav" class="ui-alt-icon ui-btn ui-shadow ui-corner-all ui-icon-home ui-btn-icon-notext">Home</a>-->
                ...
                <!-- <a href="<?php echo $oCRNRSTN_USR->getEnvResource('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_USR->getEnvResource('ROOT_PATH_CLIENT_HTTP_DIR'); ?>dashboard/" class="ui-alt-icon ui-btn ui-shadow ui-corner-all ui-icon-grid ui-btn-icon-notext" data-ajax="false">Dashboard</a> -->
        ...
        <div style="float:right;padding:12px 10px 0 0; "><a href="<?php echo $oCRNRSTN_USR->getEnvResource('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_USR->getEnvResource('ROOT_PATH_CLIENT_HTTP_DIR'); ?>" data-ajax="false" style="text-decoration:none;"><img src="<?php echo $oCRNRSTN_USR->getEnvResource('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_USR->getEnvResource('ROOT_PATH_CLIENT_HTTP_DIR');  ?>common/imgs/logo_128_sm.gif" width="51" height="31" alt="CRNRSTN Suite :: 2.0.0" title="CRNRSTN Suite :: 2.0.0"></a></div>
		...
		if(isset($tmp_pageName_Header)){
			echo '<h3 style="text-align:left; margin-left: 15px; padding-bottom:10px; font-weight:bold;">'.$tmp_pageName_Header.'</h3><div class="hdr_pg_ttl_hr_btm"></div>';
		}
                ...
                <div data-role="controlgroup" data-type="horizontal" data-mini="true">
                    <fieldset data-role="controlgroup" data-type="horizontal" data-mini="true">
                        ...
                        if($oMiniNav->loadLink('page_bgcolor')){
                            ...
                            <a href="<?php echo $oMiniNav->returnLinkURI('page_bgcolor'); ?>" class="ui-alt-icon ui-btn ui-shadow ui-corner-all ui-icon-arrow-d ui-btn-inline" data-rel="popup" data-transition="slideup">Blue</a>
                        ...
                        if($oMiniNav->loadLink('page_bgopacity')){
                            ...
                            <a href="<?php echo $oMiniNav->returnLinkURI('page_bgopacity'); ?>" class="ui-alt-icon ui-btn ui-shadow ui-corner-all ui-icon-eye ui-btn-inline" data-rel="popup" data-transition="slideup">0.8</a>
		...
		?>
        <div style="padding:5px; font-weight:normal;">Showing search results for <em style="color:#06C;"><?php echo $oCRNRSTN_USR->oHTTP_MGR->extractData($_GET, 'q'); ?></em>. Returned in <?php echo $oCRNRSTN_USR->wallTime(); ?> seconds.</div>
		<?php	
		}
