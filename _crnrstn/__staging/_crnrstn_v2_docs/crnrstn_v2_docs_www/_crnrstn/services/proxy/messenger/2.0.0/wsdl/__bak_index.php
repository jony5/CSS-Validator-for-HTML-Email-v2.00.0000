...
#error_log("/services/ index.php (8) Value for DOCUMENT_ROOT: ".$oCRNRSTN_USR->getEnvResource('DOCUMENT_ROOT')." and _CRNRSTN_ENV_KEY :: ".$_SESSION['jRs72bd0'.'CRNRSTN'.crc32('_CRNRSTN_ENV_KEY')]);
#require($oCRNRSTN_USR->getEnvResource('DOCUMENT_ROOT').'/services/common/classes/webservice.inc.php');
require($oCRNRSTN_USR->getEnvResource('DOCUMENT_ROOT').$oCRNRSTN_USR->getEnvResource('DOCUMENT_ROOT_DIR').'/_crnrstn/class/soa/crnrstn.webservice.inc.php');

//
// INSTANTIATE SOAP SERVER AND PROVIDE SESSION ACCESS TO ENVIRONMENTAL CLASS OBJECT
$server = new soap_server();
$server->debug_flag = false;
$server->configureWSDL("CRNRSTN_MESSENGER_FROM_NORTH", $oCRNRSTN_USR->getEnvResource('SOA_NAMESPACE'));
