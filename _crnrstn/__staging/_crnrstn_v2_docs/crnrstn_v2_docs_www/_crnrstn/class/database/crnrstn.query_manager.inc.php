...
#  CLASS VERSION :: 1.0.0
#  CLASS DATE :: Mon July 13, 2020 @ 0518hrs
...
class crnrstn_query_manager {
    ...
    public function __construct($oCRNRSTN_USR) {
        ...
        try{
            ...
            if(isset($oCRNRSTN_USR)){
                ...
                $this->crnrstn_query_manager_serial = self::$oCRNRSTN_USR->generateNewKey();
    ...
    public function loadPreviousRecordLookup($oDB_wiring, $oCRNRSTN_MySQLi, $result_handle, $batch_key, $result_set_key, $lookup_serial){
        ...
        try{
            ...
            if(is_object($oCRNRSTN_MySQLi)){
                ...
                if($this->pingProfileExistence($oCRNRSTN_MySQLi, $result_handle, $batch_key, $result_set_key)){
                    ...
                    $oQuery->loadPreviousRecordLookup($result_set_key, $lookup_serial);
    ...
    public function initLookupByID($oDB_wiring, $oCRNRSTN_MySQLi, $result_handle, $batch_key, $result_set_key){
        ...
        try{
            ...
            if(is_object($oCRNRSTN_MySQLi)){
                ...
                if($this->pingProfileExistence($oCRNRSTN_MySQLi, $result_handle, $batch_key, $result_set_key)){
                    ...
                    $oQuery->initLookupByID($result_set_key);
    ...
    public function addLookupFieldData($oDB_wiring, $oCRNRSTN_MySQLi, $result_handle, $batch_key, $result_set_key, $field_name, $field_value){
        ...
        try{
            ...
            if(is_object($oCRNRSTN_MySQLi)){
                ...
                if($this->pingProfileExistence($oCRNRSTN_MySQLi, $result_handle, $batch_key, $result_set_key)){
                    ...
                    return $oQuery->addLookupFieldData($result_set_key, $field_name, $field_value);
    ...
    public function retrieveDataByID($oDB_wiring, $oCRNRSTN_MySQLi, $result_handle, $batch_key, $result_set_key, $piped_lookup_fieldname, $piped_lookup_id_data){
        ...
        try{
            ...
            if(is_object($oCRNRSTN_MySQLi)) {
                ...
                if($this->pingProfileExistence($oCRNRSTN_MySQLi, $result_handle, $batch_key, $result_set_key)){
                    ...
                    return $oQuery->retrieveDataByID($result_set_key, $piped_lookup_fieldname, $piped_lookup_id_data);
        ...
        try{
            ...
            if(is_object($oCRNRSTN_MySQLi)){
                ...
                if($this->pingProfileExistence($oCRNRSTN_MySQLi, $result_handle, $batch_key, $result_set_key)){
                    ...
                    $fakey_mysqli_serial = crc32('CRNRSTN_FAKEY_CONN_SERIAL');

                    $fakey_oCRNRSTN_MySQLi = self::$oCRNRSTN_USR->return_oCRNRSTN_MySQLi_Fakey($fakey_mysqli_serial);
                    ...
                    if(!($this->pingProfileExistence($fakey_oCRNRSTN_MySQLi, $fakey_result_handle, $fakey_batch_key, $target_result_set_key))){
                        ...
                        $fakey_oCRNRSTN_MySQLi = new crnrstn_db_conn_handle(self::$oCRNRSTN_USR);
                        ...
                        $tmp_fakey_mysqli = self::$oCRNRSTN_USR->pushFakeyDBConn($fakey_mysqli_serial, $mysqli);
                        ...
                        $tmp_request_serial = crc32('CRNRSTN_FAKEY_REQUEST_SERIAL');
                    ...
                    //return $oQuery->returnDatabaseValue($result_set_key, $fieldname, $pos);
    ...
    public function returnDatabaseValue($oDB_wiring, $oCRNRSTN_MySQLi, $result_handle, $batch_key, $result_set_key, $fieldname, $pos){
    ...
    public function pingValueExistence($oDB_wiring, $oCRNRSTN_MySQLi, $result_handle, $batch_key, $result_set_key, $fieldname, $value){
        ...
        try{
            ...
            if(is_object($oCRNRSTN_MySQLi)){
                ...
                if($this->pingProfileExistence($oCRNRSTN_MySQLi, $result_handle, $batch_key, $result_set_key)){
                    ...
                    return $oQuery->pingValueExistence($fieldname, $value);
        ...
        try{
            ...
            switch($key){
                ...
                default:
                    ...
                    //
                    // HOOOSTON...VE HAF PROBLEM!
                    throw new Exception('Unknown key provided as parameter reference to oCRNRSTN_USR->processQuery() meta-data crnrstn_query_manager :: receive_processQueryParam().');
    ...
    public function returnRecordCount($oDB_wiring, $oCRNRSTN_MySQLi, $result_handle, $batch_key, $result_set_key){
        ...
        try{
            ...
            if(is_object($oCRNRSTN_MySQLi)){
                ...
                if($this->pingProfileExistence($oCRNRSTN_MySQLi, $result_handle, $batch_key, $result_set_key)){
                    ...
                    return $oQuery->returnRecordCount();
    ...
    public function sendQuery_Fakey($request_serial, $oQuery, $oDB_wiring, $fakey_oCRNRSTN_MySQLi, $fakey_result_handle, $fakey_batch_key, $target_result_set_key){
        ...
        $oUserRequest = new crnrstn_database_request(self::$oCRNRSTN_USR);
    ...
    public function load_databaseQuery($oDB_wiring, $oCRNRSTN_MySQLi, $result_handle, $batch_key, $result_set_key, $query){

        try{

            if(is_object($oCRNRSTN_MySQLi)){

                $oQuery = new crnrstn_database_query(self::$oCRNRSTN_USR);
