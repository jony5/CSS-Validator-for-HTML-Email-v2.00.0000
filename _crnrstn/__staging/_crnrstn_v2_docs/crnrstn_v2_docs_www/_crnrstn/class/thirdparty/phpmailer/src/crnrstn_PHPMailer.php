<?php
/**
 * crnrstn_PHPMailer - PHP email creation and transport class.
 * PHP Version 5.5.
 *
 * @see https://github.com/PHPMailer/PHPMailer/ The crnrstn_PHPMailer GitHub project
 *
...
class crnrstn_PHPMailer
{
     ...
     * If empty, crnrstn_PHPMailer attempts to find one with, in order,
     * $_SERVER['SERVER_NAME'], gethostname(), php_uname('n'), or the value
     * 'localhost.localdomain'.
     *
     * @see crnrstn_PHPMailer::$Helo
     *
     * @var string
     */
    public $Hostname = '';
     ...
     * Default is $Hostname. If $Hostname is empty, crnrstn_PHPMailer attempts to find
     * one with the same method described above for $Hostname.
     *
     * @see crnrstn_PHPMailer::$Hostname
     *
     * @var string
     */
    public $Helo = '';
     ...
     *
     * @see crnrstn_PHPMailer::$Username
     * @see crnrstn_PHPMailer::$Password
     *
     * @var bool
     */
    ...
    /**
     * An instance of the crnrstn_PHPMailer OAuth class.
     *
     * @var crnrstn_OAuth
     */
    protected $oauth;
     ...
     * By default crnrstn_PHPMailer will use `echo` if run from a `cli` or `cli-server` SAPI, `html` otherwise.
     ...
     * Options: An empty string for crnrstn_PHPMailer default, whitespace/null for none, or a string to use.
     *
     * @var string|null
     */
    public $XMailer = '';
     ...
     *
     * @see crnrstn_PHPMailer::validateAddress()
     *
     * @var string|callable
     */
     ...
     *
     * @see crnrstn_PHPMailer::$to
     * @see crnrstn_PHPMailer::$cc
     * @see crnrstn_PHPMailer::$bcc
     *
     * @var array
     */
     ...
     * @see crnrstn_PHPMailer::$cc
     * @see crnrstn_PHPMailer::$bcc
     * @see crnrstn_PHPMailer::$all_recipients
     *
     * @var array
     */
    ...
    /**
     * The crnrstn_PHPMailer Version number.
     *
     * @var string
     */
    const VERSION = '6.1.6';
     ...
     */
    public function __construct($oCRNRSTN_USR, $exceptions = null)
    {
        self::$oCRNRSTN_USR = $oCRNRSTN_USR;

        $this->SMTPDebug = self::$oCRNRSTN_USR->PHPMAILER_debugMode;
     ...
     *@see crnrstn_PHPMailer::$Debugoutput
     * @see crnrstn_PHPMailer::$SMTPDebug
     *
     * @see crnrstn_SMTP::$do_debug).
     *
     */
    protected function edebug($str, $line_num=NULL, $method=NULL, $file=NULL)
    {
        ...
        //
        // CRNRSTN v2.0.0 ERROR LOGGING SUPPORT
        self::$oCRNRSTN_USR->error_log($str, $line_num, $method, $file, 'CRNRSTN_oGABRIEL');
    ...
    /**
     * Add an address to one of the recipient arrays or to the ReplyTo array. Because crnrstn_PHPMailer
     * can't validate addresses with an IDN without knowing the crnrstn_PHPMailer::$CharSet (that can still
    ...
    protected function addOrEnqueueAnAddress($kind, $address, $name)
    {
        ...
        // Enqueue addresses with IDN until we know the crnrstn_PHPMailer::$CharSet.
     ...
     *
     * ```php
     * crnrstn_PHPMailer::validateAddress('user@example.com', function($address) {
     *     return (strpos($address, '@') !== false);
     * });
     * ```
     *
     * You can also set the crnrstn_PHPMailer::$validator static to a callable, allowing built-in methods to use your validator.
     *
     ...
     * Important: Address must be passed in same encoding as currently set in crnrstn_PHPMailer::$CharSet.
     ...
     *@throws crnrstn_Exception
     *
     * @see crnrstn_PHPMailer::$Sendmail
     *
     */
    ...
    public function getSMTPInstance()
    {
        if (!is_object($this->smtp)) {
            $this->smtp = new crnrstn_SMTP(self::$oCRNRSTN_USR);
        }
     ...
     *@throws crnrstn_Exception
     *
     * @see crnrstn_PHPMailer::setSMTPInstance() to use a different class.
     *
     * @uses \PHPMailer\crnrstn_PHPMailer\crnrstn_SMTP
     *
     */
    ...
    public function smtpConnect($options = null)
    {
        ...
        foreach ($hosts as $hostentry) {
            ...
            if (!preg_match(
                ...
                $this->edebug($this->lang('invalid_hostentry') . ' ' . trim($hostentry), __LINE__, __METHOD__, __FILE__);
            ...
            if (!static::isValidHost($hostinfo[2])) {
                $this->edebug($this->lang('invalid_host') . ' ' . $hostinfo[2], __LINE__, __METHOD__, __FILE__);
                continue;
            }
            $prefix = '';
...
//            $result .= static::$LE;
     ...
     * crnrstn_PHPMailer only supports some preset message types, not arbitrary MIME structures.
     */
     ...
     * Explicitly *does not* support passing URLs; crnrstn_PHPMailer is not an HTTP client.
     ...
     *                            crnrstn_PHPMailer will attempt to set a MIME type for the attachment.
    ...
    protected function lang($key)
    {
        ...
        if (array_key_exists($key, $this->language)) {
            if ('smtp_connect_failed' === $key) {
                ...
                //but it's usually not crnrstn_PHPMailer's fault.
     ...
     * @throws crnrstn_Exception
     *
     * @see crnrstn_PHPMailer::html2text()
     */
