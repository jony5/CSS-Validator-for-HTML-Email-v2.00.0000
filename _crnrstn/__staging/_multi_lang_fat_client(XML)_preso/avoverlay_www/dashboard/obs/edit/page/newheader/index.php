...
if($oCRNRSTN_ENV->oSESSION_MGR->getSessionParam("DEVICETYPE") == "m" || $oCRNRSTN_ENV->getEnvParam('MOBILE_ONLY') == true){
    ...
    <div data-role="page" id="myPage">
        ...
        <div data-role="popup" id="popupMenuLangSelect" data-theme="a" class="ui-content">
            <fieldset data-role="controlgroup" style="min-width:210px;">
                ...
                for($iii=0; $iii<$tmp_loop_size; $iii++){
                    ...
                    $tmp_output_HTML .= '<input type="radio" name="radio_curr_lang" id="radio-v-1_'.$tmp_langid.'" value="'.$tmp_langid.'" '.$tmp_checked.' onchange="updateLangInputValue(\'input#new_elem_lang_id\',\''.$tmp_langid.'\',\''.$tmp_langname.'\',\''.$tmp_langname_en.'\');">
        ...
        <div role="main" class="ui-content">
            ...
            <h2 style=" padding-bottom:0px; margin-bottom:0px;">Add Page Header</h2>
            <div class="cb_10"></div>

            <form action="#" method="post" name="new_page_header" id="new_page_header"  enctype="multipart/form-data" data-ajax="false">

                <textarea cols="40" rows="8" name="header_copy" id="header_copy" placeholder="Enter page header text..."></textarea>
                ...
                <input type="hidden" name="postid" value="new_page_header">
            ...
            <script type="application/javascript" language="javascript">
                $( "#new_page_header" ).submit(function( event ) {
                    //
                    // VALIDATE FORM
