...
$oCRNRSTN = new crnrstn('hello!SRrHEARTn42h3', 0);
...
$oCRNRSTN->initLogging('CYEXX_SYSTEMS', 'EMAIL','j5@jony5.com');				// SYSTEM DEFAULT ERROR LOGGING
...
$oCRNRSTN->addDatabase('LOCALHOST_MAC', '/var/www/html/jony5/config.database.secure/_crnrstn.db.config.inc.php');
$oCRNRSTN->addDatabase('CYEXX_SYSTEMS', '/home2/jony5/public_html/config.database.secure/_crnrstn.db.config.inc.php');
...
if(!$oCRNRSTN_ENV->isConfigured($oCRNRSTN)){
    ...
    */
	...
	$oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'DOMAIN', 'avoverlay.jony5.com');
	$oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'SERVER_NAME', 'avoverlay.jony5.com');
	...
	$oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'DOCUMENT_ROOT', '/home2/jony5/avoverlay.jony5.com'); # VALUE FOR YOUR SERVER['DOCUMENT_ROOT']
	$oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'DOCUMENT_ROOT_DIR', '');
	$oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'ROOT_PATH_CLIENT_HTTP', 'http://avoverlay.jony5.com/');
    $oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'ROOT_PATH_CLIENT_HTTP_PROD', 'http://avoverlay.jony5.com/');
	...
	$oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'MAILER_FROM_EMAIL', 'noreply_audiovideo@avoverlay.jony5.com');
	$oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'MAILER_FROM_NAME', 'Audio Video :: Support Mailer');
	$oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'MAILER_AUTHKEY', 'Pv2bduy|>4}zP2L-<aJNBza?!#bLf{!wc1$1k$;cs=fFO~u}D');
	$oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'APP_NAME', 'avoverlay');
    $oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'SESSION_EXPIRE', 'INTERVAL 30 MINUTE');
    $oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'PWD_RESET_LINK_EXPIRE', 'INTERVAL 30 MINUTE');
    $oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'ADMIN_NOTIFICATIONS_EMAIL', 'j5@jony5.com');
    $oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'ADMIN_NOTIFICATIONS_RECIPIENTNAME', 'Jonathan J5 Harris');
    $oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'SMS_NOTIFICATIONS_ENDPOINT', '7708838879@messaging.sprintpcs.com');
    $oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'SYSTEM_MSG_FROM_EMAIL', 'webmaster@avoverlay.jony5.com');
    $oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'SYSTEM_MSG_FROM_NAME', 'Jonathan J5 Harris');
    $oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'COPY_HASH_ALGO', 'sha512');
    $oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'MAX_MINISTRY_ELEM_4_TRANSLATE', 4);
    $oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'MAX_CMS_ELEM_4_TRANSLATE', 2);
    $oCRNRSTN->defineEnvResource('CYEXX_SYSTEMS', 'MAX_DRAFT_ELEM_4_APPROVE', 3);
			
	//
	// BEGIN CONFIG FOR NEXT ENVIRONMENT
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'DOMAIN', '172.16.225.128');
	...
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'DOCUMENT_ROOT_DIR', '/avoverlay');
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'ROOT_PATH_CLIENT_HTTP_PROD', 'http://avoverlay.jony5.com/');
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'ROOT_PATH_CLIENT_HTTP', 'http://172.16.225.128/');
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'ROOT_PATH_CLIENT_HTTP_DIR', 'avoverlay/');
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'SOA_NAMESPACE', 'http://172.16.225.128/soap/services');
	...
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'WSDL_URI', 'http://172.16.225.128/services/soa/crnrstn/1.0.0/wsdl/index.php?wsdl');
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'WSDL_CACHE_TTL','80');	
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'MAILER_FROM_EMAIL', 'noreply_audiovideo@avoverlay.jony5.com');
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'MAILER_FROM_NAME', 'Audio Video :: Support Mailer');
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'MAILER_AUTHKEY', 'Pv2bduy|>4}zP2L-<aJNBza?!#bLf{!wc1$1k$;cs=fFO~u}D');
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'APP_NAME', 'avoverlay');
    ...
    $oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'ADMIN_NOTIFICATIONS_EMAIL', 'j5@jony5.com');
    $oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'ADMIN_NOTIFICATIONS_RECIPIENTNAME', 'Jonathan J5 Harris');
    $oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'SMS_NOTIFICATIONS_ENDPOINT', '7708838879@messaging.sprintpcs.com');
    $oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'SYSTEM_MSG_FROM_EMAIL', 'webmaster@avoverlay.jony5.com');
    $oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'SYSTEM_MSG_FROM_NAME', 'Jonathan J5 Harris');
    $oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'COPY_HASH_ALGO', 'sha512');
    $oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'MAX_MINISTRY_ELEM_4_TRANSLATE', 2);
    ...
    $oCRNRSTN->defineEnvResource('*', 'MOBILE_ONLY', true);

    $oCRNRSTN->defineEnvResource('*','MOBILE_WEB_MAX_RECENT_ACTIVITY',10);
    $oCRNRSTN->defineEnvResource('*','DESKTOP_WEB_MAX_RECENT_ACTIVITY',20);
