...
//
// LANGUAGE SUPPORT
$tmp_lang_elem = 'SITE_TITLE|SITE_TITLE_STYLED|SITE_FOOTER_RIGHTS|SITE_TITLE_WEB_DEV|SITE_TITLE_DIGIT_MARKET|SITE_TITLE_AND|ERR_REQ_EMAIL|ERR_VALID_EMAIL|ERR_REQ_FNAME|ERR_REQ_LNAME';
	...
	<div role="main" class="ui-content">
		<h1>Your request has been received.</h1>
      	...
      	<div class="ui-body ui-body-a ui-corner-all">
            <p> Thank you for contacting us.<br />We'll be in touch.</p>
        </div>
        <div class="cb_20"></div>
