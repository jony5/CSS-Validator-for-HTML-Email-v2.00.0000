...
$this->oMYSQLI_CONN_MGR->addConnection('CYEXX_SYSTEMS', 'localhost', 'jony5_prod01', '123456789', 'jony5_prod01','3306');
$this->oMYSQLI_CONN_MGR->addConnection('CYEXX_WWW_SYSTEMS', 'localhost', 'jony5_prod01', '123456789', 'jony5_prod01','3306');
