...
'log_contact_req_CHK_OPTIN' => 22, 'log_contact_req_CHK_GATEWAY' => 23,'log_contact_req_CHK_SOCIAL' => 24,'log_contact_req_CHK_SCA' => 25,'log_contact_req_CHK_CMS' => 26,' log_contact_req_CHK_DESIGN' => 27,'log_contact_req_CHK_EXTRANET' => 28, 'log_contact_req_CHK_EMAIL_COPYWRITING' => 29,'log_contact_req_CHK_DATA_CAPTURE' => 30,'log_contact_req_CHK_HTML_EMAIL_DES' => 31,'log_contact_req_CHK_HYGENE' => 32, 'log_contact_req_CHK_EMAIL_CODING' => 33, 'log_contact_req_CHK_AUTOMATION' => 34, 'log_contact_req_CHK_CAMP_MGMT' => 35, 'log_contact_req_CHK_LP' => 36,'log_contact_req_CHK_CAMP_REPORTING' => 37, 'log_contact_req_CHK_EMAIL_SOCIAL' => 38,'log_contact_req_CHK_IP_REP' => 39,'log_contact_req_CHK_FTAF' => 40,'log_contact_req_CHK_SEGMENTATION' => 41, 'log_contact_req_DATECREATED' => 42
	*/			
				...
				$this->emailDataElements['html'] = $this->dynInject('/{%ROOT_PATH_CLIENT_HTTP%}/', self::$oUserEnvironment->getEnvParam('ROOT_PATH_CLIENT_HTTP'), $this->emailDataElements['html']);
				$this->emailDataElements['html'] = $this->dynInject('/{%ROOT_PATH_CLIENT_HTTP_DIR%}/', self::$oUserEnvironment->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR'), $this->emailDataElements['html']);
				...
				$this->emailDataElements['text'] = $this->dynInject('/{%ROOT_PATH_CLIENT_HTTP%}/',self::$oUserEnvironment->getEnvParam('ROOT_PATH_CLIENT_HTTP'), $this->emailDataElements['text']);
				...
				$this->emailDataElements['text'] = $this->dynInject('/{%ROOT_PATH_CLIENT_HTTP_DIR%}/',self::$oUserEnvironment->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR'), $this->emailDataElements['text']);
			...
			case 'CONTACT_CONFIRM':
				...
				$tmp_unsub = self::$oUserEnvironment->getEnvParam('ROOT_PATH_CLIENT_HTTP')."unsub/?mid=".self::$msgQueue_ARRAY[$queuePosition][self::$queryDescript_ARRAY['sys_msg_queue_MSG_SOURCEID']]."&isocode=".self::$msgQueue_ARRAY[$queuePosition][self::$queryDescript_ARRAY['sys_msg_queue_LANGCODE']];
				...
				// HTML VERSION
				$this->emailDataElements['html'] = $this->dynInject('/{%ROOT_PATH_CLIENT_HTTP%}/', self::$oUserEnvironment->getEnvParam('ROOT_PATH_CLIENT_HTTP'), $this->emailDataElements['html']);
				$this->emailDataElements['html'] = $this->dynInject('/{%ROOT_PATH_CLIENT_HTTP_DIR%}/', self::$oUserEnvironment->getEnvParam('ROOT_PATH_CLIENT_HTTP'), $this->emailDataElements['html']);
				//$this->emailDataElements['html'] = $this->dynInject('/{%EMAIL_ANALYTICS%}/', $this->msg_queue_EMAIL_ANALYTICS, $this->emailDataElements['html']);
			...
			case 'PASSWORD_RESET':
				...
				$tmp_reset_endpoint = self::$oUserEnvironment->getEnvParam('ROOT_PATH_CLIENT_HTTP')."account/pwdreset/?rid=".self::$frm_input_ARRAY['REQUESTID'];
				$tmp_unsub = self::$oUserEnvironment->getEnvParam('ROOT_PATH_CLIENT_HTTP')."unsub/?mid=".self::$msgQueue_ARRAY[$queuePosition][self::$queryDescript_ARRAY['sys_msg_queue_MSG_SOURCEID']]."&isocode=".self::$msgQueue_ARRAY[$queuePosition][self::$queryDescript_ARRAY['sys_msg_queue_LANGCODE']];
			...
			case 'ACCOUNT_ACTIVATE':
				...
				$this->emailDataElements['activateURI'] = self::$oUserEnvironment->getEnvParam('ROOT_PATH_CLIENT_HTTP').'account/activate/?ak='.self::$msgQueue_ARRAY[$queuePosition][self::$queryDescript_ARRAY['sys_msg_queue_ACTIVATION_KEY']].'&uid='.self::$msgQueue_ARRAY[$queuePosition][self::$queryDescript_ARRAY['sys_msg_queue_USERID']]."&isocode=".self::$msgQueue_ARRAY[$queuePosition][self::$queryDescript_ARRAY['sys_msg_queue_LANGCODE']];
				$tmp_unsub = self::$oUserEnvironment->getEnvParam('ROOT_PATH_CLIENT_HTTP')."unsub/?mid=".self::$msgQueue_ARRAY[$queuePosition][self::$queryDescript_ARRAY['sys_msg_queue_MSG_SOURCEID']]."&isocode=".self::$msgQueue_ARRAY[$queuePosition][self::$queryDescript_ARRAY['sys_msg_queue_LANGCODE']];
	...
	private function sendMessage(){
		...
		switch($tmp_supp_flag){
			case 1:	
				error_log("AV Overlay messenger (504) suppress this message");
				return "unsubscribe suppressed to (of ".sizeof(self::$emailSuppression_ARRAY).") ".$this->emailDataElements['addAddressEmail'];
			break;
			default:
