...
class database_integration {
    ...
    public function processUserRequest($queryType ,$oUser, $oEnv){
        return $this->executeQueryType($queryType, $oUser, $oEnv);
    }
            ...
            switch ($queryType) {
                case 'pull_page_lang_elements':
                    ...
                    for ($i = 0; $i < $tmp_loop_size; $i++) {
                        ...
                        $tmp_SELECT_ARRAY[$tmp_sel_count] = 'SELECT `cia00_sys_lang_elements`.`ELEMENT_REF_KEY`, `cia00_sys_lang_elements`.`COUNTRY_ISO_CODE`, `cia00_sys_lang_elements`.`ELEMENT_CONTENT_BLOB` AS `ELEMENT_CONTENT` FROM `cia00_sys_lang_elements` WHERE 
                        `cia00_sys_lang_elements`.`ELEMENT_REF_KEY`="'.self::$mysqli->real_escape_string($tmp_ELEMENT_KEY_ARRAY[$i]).'" AND
                        `cia00_sys_lang_elements`.`ELEMENT_REF_KEY_CRC32`="'.crc32($tmp_ELEMENT_KEY_ARRAY[$i]).'" AND
                        `cia00_sys_lang_elements`.`COUNTRY_ISO_CODE`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data("COUNTRY_ISO_CODE")).'" AND 
                        `cia00_sys_lang_elements`.`ISO_CODE_CRC32`="'.crc32($oUser->retrieve_Form_Data("COUNTRY_ISO_CODE")).'" LIMIT 1;';
    ...
    private function executeQueryType($queryType, $oUser, $oEnv)
    {
        try {
            ...
            switch ($queryType) {
                case 'get_site_activity_logs':
                    ...
                    // LANG_PACKS
                    $tmp_SELECT_ARRAY[0] = 'SELECT `cia00_lang_packs`.`LANGPACK_ID`,
...
';
                    ...
                    // SYS_LOGS
                    $tmp_SELECT_ARRAY[1] = 'SELECT `cia00_log_sys_user`.`ACTIVITY_ID`,
                        `cia00_log_sys_user`.`DATECREATED`,
                        `cia00_log_sys_user`.`MODIFIER_ID`,
                        `cia00_log_sys_user`.`ELEMENT_ID`,
                        `cia00_log_sys_user`.`ELEMENT_REF_KEY_CRC32`,
                        `cia00_log_sys_user`.`OBSCLIENT_ID`,
                        `cia00_log_sys_user`.`FULL_SCRN_PROFILE_ID`,
                        `cia00_log_sys_user`.`FULL_SCRN_PAGE_ID`,
                        `cia00_log_sys_user`.`MINI_PROFILE_ID`,
                        `cia00_log_sys_user`.`COMPONENT_ID`,
                        `cia00_log_sys_user`.`ACTIVITY_DESCRIPTION`,
                        `cia00_log_sys_user`.`ACTIVITY_DESCRIPTION_BLOB`,
                        `cia00_log_sys_user`.`PHPSESSION`,
                        `cia00_log_sys_user`.`IPADDRESS_V6`,
                        `cia00_log_sys_user`.`IPADDRESS`,
                        `cia00_log_sys_user`.`HTTP_USER_AGENT`,
                        `cia00_log_sys_user`.`CHANNEL`
                    FROM `cia00_log_sys_user` ORDER BY `cia00_log_sys_user`.`DATECREATED` DESC LIMIT 50;
';

                    //
                    // SYSTEM_USERS
                    $tmp_SELECT_ARRAY[2] = 'SELECT `cia00_users`.`USERID`,
                        `cia00_users`.`EMAIL`,
                        `cia00_users`.`ISACTIVE`,
                        `cia00_users`.`USER_PERMISSIONS_ID`,
                        `cia00_users`.`FIRSTNAME`,
                        `cia00_users`.`FIRSTNAME_BLOB`,
                        `cia00_users`.`LASTNAME`,
                        `cia00_users`.`LASTNAME_BLOB`,
                        `cia00_users`.`STREAM_MENTION`,
                        `cia00_users`.`USER_MENTION_NOTIFICATION_ON`,
                        `cia00_users`.`LOCALITY_MENTION_NOTIFICATION_ON`,
                        `cia00_users`.`WATCH_NOTIFICATION_ON`,
                        `cia00_users`.`LOCALITY`,
                        `cia00_users`.`LOCALITY_BLOB`,
                        `cia00_users`.`LANGCODE`,
                        `cia00_users`.`LASTLOGIN`,
                        `cia00_users`.`LASTLOGIN_IP`,
                        `cia00_users`.`LOGIN_CNT`,
                        `cia00_users`.`IMAGE_NAME`,
                        `cia00_users`.`IMAGE_WIDTH`,
                        `cia00_users`.`IMAGE_HEIGHT`,
                        `cia00_users`.`ABOUT`,
                        `cia00_users`.`ABOUT_BLOB`,
                        `cia00_users`.`DATEMODIFIED`,
                        `cia00_users`.`DATECREATED`
                    FROM `cia00_users`;
                    ';

                    //
                    // SYSTEM_USER_TYPES
                    $tmp_SELECT_ARRAY[3] = 'SELECT `cia00_sys_user_types`.`TYPE_ID`,
                        `cia00_sys_user_types`.`USER_PERMISSIONS_ID`,
                        `cia00_sys_user_types`.`ISACTIVE`,
                        `cia00_sys_user_types`.`NAME`,
                        `cia00_sys_user_types`.`DESCRIPTION`,
                        `cia00_sys_user_types`.`SEQUENCE`,
                        `cia00_sys_user_types`.`CREATOR_ID`,
                        `cia00_sys_user_types`.`CREATOR_IP_V6`,
                        `cia00_sys_user_types`.`CREATOR_IP`,
                        `cia00_sys_user_types`.`CREATOR_SESSION_ID`,
                        `cia00_sys_user_types`.`MODIFIER_ID`,
                        `cia00_sys_user_types`.`MODIFIER_IP_V6`,
                        `cia00_sys_user_types`.`MODIFIER_IP`,
                        `cia00_sys_user_types`.`MODIFIER_SESSION_ID`,
                        `cia00_sys_user_types`.`DATEMODIFIED`,
                        `cia00_sys_user_types`.`DATECREATED`
                    FROM `cia00_sys_user_types`;
                    ';

                    //
                    // OVERLAY_PAGES
                    $tmp_SELECT_ARRAY[4] = 'SELECT `cia00_overlay_fullscrn_pages`.`PAGE_ID`,
                        `cia00_overlay_fullscrn_pages`.`PROFILE_ID`,
                        `cia00_overlay_fullscrn_pages`.`ISACTIVE`,
                        ...
                        `cia00_overlay_fullscrn_pages`.`CREATOR_IP_V6`,
                        ...
                        `cia00_overlay_fullscrn_pages`.`MODIFIER_IP_V6`,
                    ...
                    $tmp_SELECT_ARRAY[5] = 'SELECT `cia00_overlay_mini_profile`.`PROFILE_ID`,
                ...
                ';
                    ...
                    $tmp_SELECT_ARRAY[6] = 'SELECT `cia00_overlay_fullscrn_profile`.`PROFILE_ID`,
                        ...
                        `cia00_overlay_fullscrn_profile`.`CREATOR_IP_V6`,
                        ...
                        `cia00_overlay_fullscrn_profile`.`MODIFIER_IP_V6`,
...
';
                        // LANG_REQUESTS
                        $tmp_SELECT_ARRAY[1] = 'SELECT `cia00_profile_lang_requests`.`REQUEST_ID`,
                            ...
                            INET6_NTOA(`cia00_profile_lang_requests`.`CREATOR_IP_V6`) AS CREATOR_IP_V6,
                            INET_NTOA(`cia00_profile_lang_requests`.`CREATOR_IP`) AS CREATOR_IP,
                            `cia00_profile_lang_requests`.`CREATOR_SESSION_ID`,
                            `cia00_profile_lang_requests`.`MODIFIER_ID`,
                            INET6_NTOA(`cia00_profile_lang_requests`.`MODIFIER_IP_V6`) AS MODIFIER_IP_V6,
                            INET_NTOA(`cia00_profile_lang_requests`.`MODIFIER_IP`) AS MODIFIER_IP,
                        ...
                        FROM `cia00_profile_lang_requests`
                        WHERE `cia00_profile_lang_requests`.`ISACTIVE`="1";
';

                        // MINISTRY_LANG_ELEMENTS_FOR_PUBLISH
                        $tmp_SELECT_ARRAY[2] = 'SELECT `cia00_lang_elem_components`.`ELEMENT_ID`,
                        ...
                        INET6_NTOA(`cia00_lang_elem_components`.`CREATOR_IP_V6`) AS CREATOR_IP_V6,
                        INET_NTOA(`cia00_lang_elem_components`.`CREATOR_IP`) AS CREATOR_IP,
                        `cia00_lang_elem_components`.`CREATOR_SESSION_ID`,
                        `cia00_lang_elem_components`.`MODIFIER_ID`,
                        INET6_NTOA(`cia00_lang_elem_components`.`MODIFIER_IP_V6`) AS MODIFIER_IP_V6,
                        INET_NTOA(`cia00_lang_elem_components`.`MODIFIER_IP`) AS MODIFIER_IP,
                        ...
                        WHERE `cia00_lang_elem_components`.`ELEMENT_ID`="'.self::$mysqli->real_escape_string($tmp_translation_element_id).'"
                        AND `cia00_lang_elem_components`.`ELEMENT_ID_CRC32`="'.crc32($tmp_translation_element_id).'"
                        AND `cia00_lang_elem_components`.`COPY_ID`="'.self::$mysqli->real_escape_string($tmp_translation_copy_id).'"
                        AND `cia00_lang_elem_components`.`COPY_ID_CRC32`="'.crc32($tmp_translation_copy_id).'"
                        LIMIT 1;
';
                        //error_log('9080 ->'.$tmp_SELECT_ARRAY[2]);
                        // TRANSLATOR_LANGS
                        $tmp_SELECT_ARRAY[3] = 'SELECT `cia00_translator_lang_id`.`RELATION_ID`,
                            `cia00_translator_lang_id`.`USERID`,
                            `cia00_translator_lang_id`.`LANG_ID`,
                            `cia00_translator_lang_id`.`ISACTIVE`,
                            `cia00_translator_lang_id`.`DATEMODIFIED`,
                            `cia00_translator_lang_id`.`DATECREATED`
                        FROM `cia00_translator_lang_id`
                        WHERE `cia00_translator_lang_id`.`ISACTIVE`="1";
';

                        // MINISTRY_LANG_ELEMENTS_TRANSLATION
                        $tmp_SELECT_ARRAY[4] = 'SELECT `cia00_lang_elem_components`.`ELEMENT_ID`,
                        `cia00_lang_elem_components`.`COPY_ID`,
                        `cia00_lang_elem_components`.`COMPONENT_ID`,
                        `cia00_lang_elem_components`.`PAGE_ID`,
                        `cia00_lang_elem_components`.`PROFILE_ID`,
                        ...
                        `cia00_lang_elem_components`.`DATECREATED`
                        FROM `cia00_lang_elem_components`
                        WHERE `cia00_lang_elem_components`.`COPY_ID`="'.self::$mysqli->real_escape_string($tmp_translation_copy_id).'"
                        AND `cia00_lang_elem_components`.`COPY_ID_CRC32`="'.crc32($tmp_translation_copy_id).'"
                        ;
';

                        // MINISTRY_LANG_ELEMENTS_PUBLISHED
                        $tmp_SELECT_ARRAY[5] = 'SELECT `cia00_lang_elem_components`.`ELEMENT_ID`,
                        `cia00_lang_elem_components`.`COPY_ID`,
                        `cia00_lang_elem_components`.`COMPONENT_ID`,
                        `cia00_lang_elem_components`.`PAGE_ID`,
                        `cia00_lang_elem_components`.`PROFILE_ID`,
                        ...
                        `cia00_lang_elem_components`.`DATECREATED`
                        FROM `cia00_lang_elem_components`
                        WHERE `cia00_lang_elem_components`.`ISACTIVE`="1" 
                        AND `cia00_lang_elem_components`.`COMPLETION_STATE`="PUBLISHED"
                        AND `cia00_lang_elem_components`.`COPY_ID`="'.self::$mysqli->real_escape_string($tmp_translation_copy_id).'"
                        AND `cia00_lang_elem_components`.`COPY_ID_CRC32`="'.crc32($tmp_translation_copy_id).'"
                      ;
';
...
';
                        ...
                        $tmp_SELECT_ARRAY[1] = 'SELECT `cia00_sys_lang_elements`.`ELEMENT_ID`,
                            `cia00_sys_lang_elements`.`ELEMENT_REF_KEY`,
                            `cia00_sys_lang_elements`.`COUNTRY_ISO_CODE`,
                            `cia00_sys_lang_elements`.`ELEMENT_CONTENT`,
                            `cia00_sys_lang_elements`.`ELEMENT_CONTENT_BLOB`,
                            `cia00_sys_lang_elements`.`ELEMENT_NAME`,
                            `cia00_sys_lang_elements`.`ELEMENT_NAME_BLOB`,
                            `cia00_sys_lang_elements`.`ELEMENT_DESCRIPTION`,
                            `cia00_sys_lang_elements`.`ELEMENT_DESCRIPTION_BLOB`,
                            `cia00_sys_lang_elements`.`CREATOR_ID`,
                            `cia00_sys_lang_elements`.`CREATOR_IP`,
                            `cia00_sys_lang_elements`.`CREATOR_SESSION_ID`,
                            `cia00_sys_lang_elements`.`MODIFIER_ID`,
                            `cia00_sys_lang_elements`.`MODIFIER_IP`,
                            `cia00_sys_lang_elements`.`MODIFIER_SESSION_ID`,
                            `cia00_sys_lang_elements`.`DATEMODIFIED`,
                            `cia00_sys_lang_elements`.`DATECREATED`
                        FROM `cia00_sys_lang_elements` 
                        WHERE `cia00_sys_lang_elements`.`COUNTRY_ISO_CODE`="en";
';
                        // TRANSLATOR_LANGS
                        $tmp_SELECT_ARRAY[2] = 'SELECT `cia00_translator_lang_id`.`RELATION_ID`,
                            `cia00_translator_lang_id`.`USERID`,
                            `cia00_translator_lang_id`.`LANG_ID`,
                            `cia00_translator_lang_id`.`ISACTIVE`,
                            `cia00_translator_lang_id`.`DATEMODIFIED`,
...
';
                        ...
                        // SITE_LANG_ELEMENTS
                        $tmp_SELECT_ARRAY[3] = 'SELECT `cia00_sys_lang_elements`.`ELEMENT_ID`,
                            `cia00_sys_lang_elements`.`ELEMENT_REF_KEY`,
                            `cia00_sys_lang_elements`.`COUNTRY_ISO_CODE`,
                            `cia00_sys_lang_elements`.`ELEMENT_CONTENT`,
                            `cia00_sys_lang_elements`.`ELEMENT_CONTENT_BLOB`,
...
';
                    // TRANSLATOR_LANGS
                    $tmp_SELECT_ARRAY[4] = 'SELECT `cia00_translator_lang_id`.`RELATION_ID`,
                        `cia00_translator_lang_id`.`USERID`,
                        `cia00_translator_lang_id`.`LANG_ID`,
                        `cia00_translator_lang_id`.`ISACTIVE`,
                        `cia00_translator_lang_id`.`DATEMODIFIED`,
...
';
                    ...
                    // SITE_LANG_ELEMENTS
                    $tmp_SELECT_ARRAY[5] = 'SELECT `cia00_sys_lang_elements`.`ELEMENT_ID`,
                        `cia00_sys_lang_elements`.`ELEMENT_REF_KEY`,
                        `cia00_sys_lang_elements`.`COUNTRY_ISO_CODE`,
                        `cia00_sys_lang_elements`.`ELEMENT_CONTENT`,
                        `cia00_sys_lang_elements`.`ELEMENT_CONTENT_BLOB`,
...
';
                    ...
                    $tmp_SELECT_ARRAY[6] = 'SELECT `cia00_lang_elem_components`.`ELEMENT_ID`,
                    `cia00_lang_elem_components`.`COPY_ID`,
                    `cia00_lang_elem_components`.`COMPONENT_ID`,
                    `cia00_lang_elem_components`.`PAGE_ID`,
                    `cia00_lang_elem_components`.`PROFILE_ID`,
                    ...
                    FROM `cia00_lang_elem_components`
                    WHERE `cia00_lang_elem_components`.`ISACTIVE`="1" 
                    AND `cia00_lang_elem_components`.`COMPLETION_STATE`= "SAINT_SAVED"
                    ;
';

                    // MINISTRY_LANG_ELEMENTS_TRANSLATION_EXCLUDE
                    $tmp_SELECT_ARRAY[7] = 'SELECT `cia00_lang_elem_components`.`ELEMENT_ID`,
                    `cia00_lang_elem_components`.`COPY_ID`,
                    `cia00_lang_elem_components`.`COMPONENT_ID`,
                    `cia00_lang_elem_components`.`PAGE_ID`,
                    `cia00_lang_elem_components`.`PROFILE_ID`,
                    ...
                    WHERE `cia00_lang_elem_components`.`ISACTIVE`="1" 
                    AND 
                          (`cia00_lang_elem_components`.`COMPLETION_STATE`= "SAINT_SAVED"
                            OR `cia00_lang_elem_components`.`COMPLETION_STATE`= "PUBLISHED"
                            OR `cia00_lang_elem_components`.`COMPLETION_STATE`= "CHECKED_OUT")
                    ;
';
                ...
                case 'update_desired_languages':
                    ...
                    if($tmp_fullscrn_profile_id!=''){
                        ...
                        for($i=0;$i<$tmp_loop_size;$i++){
                            ...
                            self::$query .= 'INSERT INTO `cia00_profile_lang_requests`
                            (`REQUEST_ID`,
                            `FULLSCRN_PROFILE_ID`,
                        ...
                        $tmp_query_prep = 'DELETE FROM `cia00_profile_lang_requests`
                ...
                case 'update_schedule_time_format':
                    ...
                    self::$query = 'UPDATE `cia00_component_schedule`
                                SET
                    ...
                    self::$query .= 'UPDATE `cia00_fullscrn_page_components`
                                SET
                                `MODIFIER_ID` = "'.$tmp_userid.'",
                                `MODIFIER_IP` = INET_ATON("' . $_SERVER['REMOTE_ADDR'] . '"),
                                `MODIFIER_SESSION_ID` = "' . session_id() . '",
                ...
                case 'sys_get_components':
                    ...
                    $tmp_SELECT_ARRAY[0] = 'SELECT `cia00_sys_page_component_types`.`TYPE_ID`,
                        `cia00_sys_page_component_types`.`TYPE_KEY`,
                        `cia00_sys_page_component_types`.`NAME`,
                        `cia00_sys_page_component_types`.`DESCRIPTION`,
                        `cia00_sys_page_component_types`.`DESCRIPTION_BLOB`,
                        `cia00_sys_page_component_types`.`URI_PATH_NEW`,
                        `cia00_sys_page_component_types`.`ISACTIVE`,
                        `cia00_sys_page_component_types`.`CREATOR_ID`,
                        `cia00_sys_page_component_types`.`CREATOR_IP`,
                        `cia00_sys_page_component_types`.`CREATOR_SESSION_ID`,
                        `cia00_sys_page_component_types`.`MODIFIER_ID`,
                        `cia00_sys_page_component_types`.`MODIFIER_IP`,
                        `cia00_sys_page_component_types`.`MODIFIER_SESSION_ID`,
                        `cia00_sys_page_component_types`.`DATEMODIFIED`,
                        `cia00_sys_page_component_types`.`DATECREATED`
                    FROM `cia00_sys_page_component_types`
                    WHERE `cia00_sys_page_component_types`.`ISACTIVE`="1" 
                    ORDER BY `cia00_sys_page_component_types`.`NAME`;
                    ';
                ...
                case 'sys_add_new_user_type':
                    ...
                    self::$query = 'INSERT INTO `cia00_sys_user_types`
                    (`TYPE_ID`,
                    `USER_PERMISSIONS_ID`,
                    `NAME`,
                    `DESCRIPTION`,
                ...
                case 'sys_add_new_component':
                    ...
                    //
                    // QUERY CONSTRUCTION ::
                    self::$query = 'INSERT INTO `cia00_sys_page_component_types`
                    (`TYPE_ID`,
                    `TYPE_KEY`,
                    `NAME`,
                    `DESCRIPTION`,
                ...
                case 'insert_subtitle_element':
                    ...
                    switch($tmp_action_type) {
                        case 'delete_subtitle':
                            ...
                            self::$query .= 'UPDATE `cia00_component_subtitle`
                            SET
                            `ISACTIVE` = "0",
                            `MODIFIER_ID` = "'.$tmp_userid.'",
                            `MODIFIER_IP` = INET_ATON("' . $_SERVER['REMOTE_ADDR'] . '"),
                        ...
                        case 'new_subtitle':
                            ...
                            //
                            // QUERY CONSTRUCTION ::
                            self::$query = 'INSERT INTO `cia00_fullscrn_page_components`
                            (`COMPONENT_ID`,
                             `COMPONENT_ID_CRC32`,
                            `PROFILE_ID`,
                            `PROFILE_ID_CRC32`,
                            ...
                            self::$query .= 'INSERT INTO `cia00_component_subtitle`
                            (`SUBTITLE_ID`,
                            `ELEMENT_ID`,
                            `ELEMENT_ID_CRC32`,
                            `COMPONENT_ID`,
                ...
                case 'insert_paragraph_element':
                    ...
                    switch($tmp_action_type) {
                        case 'delete_paragraph':
                            ...
                            self::$query .= 'UPDATE `cia00_component_paragraph`
                            SET
                            `ISACTIVE` = "0",
                            `MODIFIER_ID` = "'.$tmp_userid.'",
                            `MODIFIER_IP` = INET_ATON("' . $_SERVER['REMOTE_ADDR'] . '"),
                        ...
                        case 'new_paragraph':
                            ...
                            self::$query .= 'INSERT INTO `cia00_component_paragraph`
                            (`PARAGRAPH_ID`,
                            `ELEMENT_ID`,
                            `ELEMENT_ID_CRC32`,
                            `COMPONENT_ID`,
                ...
                case 'insert_bullet_element':
                    ...
                    switch($tmp_action_type){
                        case 'delete_bulletlist':
                            ...
                            //
                            // QUERY CONSTRUCTION ::
                            self::$query = 'UPDATE `cia00_lang_elem_components`
                            SET
                            `ISACTIVE` = "0",
                            `MODIFIER_ID` = "'.$tmp_userid.'",
                            ...
                            self::$query .= 'UPDATE `cia00_component_bulletlist`
                            SET
                            `ISACTIVE` = "0",
                            `MODIFIER_ID` = "'.$tmp_userid.'",
                            `MODIFIER_IP` = INET_ATON("' . $_SERVER['REMOTE_ADDR'] . '"),
                            ...
                            self::$query .= 'UPDATE `cia00_component_bulletlist_bullets`
                            SET
                            `ISACTIVE` = "0",
                            `MODIFIER_ID` = "'.$tmp_userid.'",
                            `MODIFIER_IP` = INET_ATON("' . $_SERVER['REMOTE_ADDR'] . '"),
                        ...
                        case 'new_bullet_point':
                            ...
                            if($tmp_component_id!=''){
                                ...
                                self::$query = 'INSERT INTO `cia00_component_bulletlist_bullets`
                                (`BULLET_ID`,
                                `ELEMENT_ID`,
                                `ELEMENT_ID_CRC32`,
                                `COMPONENT_ID`,
                                ...
                                self::$query .= 'INSERT INTO `cia00_component_bulletlist`
                                (`BULLET_LIST_ID`,
                                `COMPONENT_ID`,
                                `COMPONENT_ID_CRC32`,
                                `PAGE_ID`,
                ...
                case 'insert_schedule_element':
                    ...
                    switch($tmp_action_type){
                        case 'delete_schedule':
                            ...
                            # cia00_component_schedule
                            # cia00_component_schedule_day
                            # cia00_component_schedule_event
                            # cia00_fullscrn_page_components
                            # cia00_lang_elem_components
                            # cia00_lang_elem_search
                            ...
                            self::$query .= 'UPDATE `cia00_component_schedule_event`
                            SET
                            `ISACTIVE` = "0",
                            `MODIFIER_ID` = "'.$tmp_userid.'",
                            `MODIFIER_IP` = INET_ATON("' . $_SERVER['REMOTE_ADDR'] . '"),
                            ...
                            self::$query .= 'UPDATE `cia00_component_schedule_day`
                            SET
                            `ISACTIVE` = "0",
                            `MODIFIER_ID` = "'.$tmp_userid.'",
                            `MODIFIER_IP` = INET_ATON("' . $_SERVER['REMOTE_ADDR'] . '"),
                            ...
                            self::$query .= 'UPDATE `cia00_lang_elem_search`
                            SET
                            `ISACTIVE` = "0",
                            `DATEMODIFIED` = "'.$ts.'"
                            WHERE `COMPONENT_ID` = "'.$tmp_component_id.'"
                        ...
                        case 'new_schedule_event':
                            ...
                            self::$query = 'INSERT INTO `cia00_component_schedule_event`
                            (`EVENT_ID`,
                            `ELEMENT_ID`,
                            `ELEMENT_ID_CRC32`,
                            `DAY_ID`,
                        ...
                        case 'new_schedule_day':
                            ...
                            if($tmp_component_id!=''){
                                ...
                                self::$query .= 'INSERT INTO `cia00_component_schedule_day`
                                (`DAY_ID`,
                                `DAY_ID_CRC32`,
                                `PROFILE_ID`,
                                `PROFILE_ID_CRC32`,
                                ...
                                //
                                // QUERY CONSTRUCTION ::
                                self::$query = 'INSERT INTO `cia00_component_schedule`
                                (`SCHEDULE_ID`,
                                 `COMPONENT_ID`,
                                 `COMPONENT_ID_CRC32`,
                                `PROFILE_ID`,
                ...
                case 'sys_get_colors':
                    ...
                    $tmp_SELECT_ARRAY[0] = 'SELECT `cia00_colors_hex`.`COLOR_ID`,
                    ...
                    WHERE `cia00_colors_hex`.`ISACTIVE`="1" 
                    ORDER BY `cia00_colors_hex`.`COLOR_NAME`;
                    ';
                ...
                case 'sys_user_type_get':
                    ...
                    // QUERY CONSTRUCTION ::
                    $tmp_SELECT_ARRAY = array();
                    $tmp_SELECT_ARRAY[0] = 'SELECT `cia00_sys_user_types`.`TYPE_ID`,
                        `cia00_sys_user_types`.`USER_PERMISSIONS_ID`,
                        `cia00_sys_user_types`.`NAME`,
                        `cia00_sys_user_types`.`DESCRIPTION`,
                        `cia00_sys_user_types`.`CREATOR_ID`,
                        ...
                        `cia00_sys_user_types`.`DATECREATED`
                    FROM `cia00_sys_user_types`
                    WHERE  `cia00_sys_user_types`.`ISACTIVE`="1" 
                    ORDER BY `cia00_sys_user_types`.`SEQUENCE` ASC;
                    ';

                    $tmp_SELECT_ARRAY[1] = 'SELECT `cia00_lang_packs`.`LANGPACK_ID`,
                        `cia00_lang_packs`.`LANG_ID`,
                        `cia00_lang_packs`.`NAME`,
                        `cia00_lang_packs`.`NATIVE_NAME`,
                        `cia00_lang_packs`.`NATIVE_NAME_BLOB`,
                ...
                case 'sys_add_new_color':
                    ...
                    //
                    // QUERY CONSTRUCTION ::
                    self::$query = 'INSERT INTO `cia00_colors_hex`
                    (`COLOR_ID`,
                ...
                case 'update_page_bg_opacity':
                    ...
                    //
                    // QUERY CONSTRUCTION ::
                    self::$query = 'UPDATE `cia00_overlay_fullscrn_pages`
                    SET
                ...
                case 'get_obs_fullscrn_page_data':
                    ...
                    $tmp_SELECT_ARRAY[2] = 'SELECT `cia00_colors_hex`.`COLOR_ID`,
                        `cia00_colors_hex`.`COLOR_APPLICATION_KEY`,
                        `cia00_colors_hex`.`COLOR_HEX`,
                        `cia00_colors_hex`.`ISACTIVE`,
                        `cia00_colors_hex`.`COLOR_NAME`,
                    ...
                    $tmp_SELECT_ARRAY[3] = 'SELECT `cia00_overlay_fullscrn_pages`.`PAGE_ID`,
                        `cia00_overlay_fullscrn_pages`.`PROFILE_ID`,
                        `cia00_overlay_fullscrn_pages`.`PAGE_NAME`,
                        `cia00_overlay_fullscrn_pages`.`PAGE_NAME_BLOB`,
                        `cia00_overlay_fullscrn_pages`.`BGCOLOR_HEX`,
                        ...
                        `cia00_overlay_fullscrn_pages`.`DATECREATED`
                    FROM `cia00_overlay_fullscrn_pages` 
                    WHERE  `cia00_overlay_fullscrn_pages`.`PAGE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PAGE_ID')).'" 
                    AND `cia00_overlay_fullscrn_pages`.`PAGE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PAGE_ID')).'" LIMIT 1;
                    ';
                    ...
                    `cia00_lang_elem_components`.`DATECREATED`
                    FROM `cia00_lang_elem_components`
                    WHERE `cia00_lang_elem_components`.`PROFILE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PROFILE_ID')).'" 
                    AND `cia00_lang_elem_components`.`PROFILE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PROFILE_ID')).'" 
                    AND `cia00_lang_elem_components`.`PAGE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PAGE_ID')).'" 
                    AND `cia00_lang_elem_components`.`PAGE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PAGE_ID')).'" 
                    AND `cia00_lang_elem_components`.`ISACTIVE`="1"
                    ;';

                    //
                    // PAGE_COMPONENTS
                    $tmp_SELECT_ARRAY[5] = 'SELECT `cia00_fullscrn_page_components`.`COMPONENT_ID`,
                    `cia00_fullscrn_page_components`.`PROFILE_ID`,
                    `cia00_fullscrn_page_components`.`PAGE_ID`,
                    `cia00_fullscrn_page_components`.`COMPONENT_TYPE_KEY`,
                    `cia00_fullscrn_page_components`.`PAGE_SEQUENCE`,
                    `cia00_fullscrn_page_components`.`PROFILE_SEQUENCE`,
                    `cia00_fullscrn_page_components`.`ISACTIVE`,
                    `cia00_fullscrn_page_components`.`CREATOR_ID`,
                    `cia00_fullscrn_page_components`.`CREATOR_IP`,
                    `cia00_fullscrn_page_components`.`CREATOR_SESSION_ID`,
                    `cia00_fullscrn_page_components`.`MODIFIER_ID`,
                    `cia00_fullscrn_page_components`.`MODIFIER_IP`,
                    `cia00_fullscrn_page_components`.`MODIFIER_SESSION_ID`,
                    `cia00_fullscrn_page_components`.`DATEMODIFIED`,
                    `cia00_fullscrn_page_components`.`DATECREATED`
                    FROM `cia00_fullscrn_page_components`
                    WHERE `cia00_fullscrn_page_components`.`PROFILE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PROFILE_ID')).'" 
                    AND `cia00_fullscrn_page_components`.`PROFILE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PROFILE_ID')).'"
                    AND `cia00_fullscrn_page_components`.`PAGE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PAGE_ID')).'" 
                    AND `cia00_fullscrn_page_components`.`PAGE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PAGE_ID')).'" 
                    AND `cia00_fullscrn_page_components`.`ISACTIVE`="1"
                    ORDER BY `cia00_fullscrn_page_components`.`PAGE_SEQUENCE`
                    ;';

                    //
                    // PAGE_SCHEDULES
                    $tmp_SELECT_ARRAY[6] = 'SELECT `cia00_component_schedule`.`SCHEDULE_ID`,
                        `cia00_component_schedule`.`COMPONENT_ID`,
                        `cia00_component_schedule`.`PROFILE_ID`,
                        `cia00_component_schedule`.`PAGE_ID`,
                        `cia00_component_schedule`.`ISACTIVE`,
                        `cia00_component_schedule`.`DATE_FORMAT`,
                        `cia00_component_schedule`.`TIME_FORMAT`,
                        `cia00_component_schedule`.`CREATOR_ID`,
                        `cia00_component_schedule`.`CREATOR_IP`,
                        `cia00_component_schedule`.`CREATOR_SESSION_ID`,
                        `cia00_component_schedule`.`MODIFIER_ID`,
                        `cia00_component_schedule`.`MODIFIER_IP`,
                        `cia00_component_schedule`.`MODIFIER_SESSION_ID`,
                        `cia00_component_schedule`.`DATEMODIFIED`,
                        `cia00_component_schedule`.`DATECREATED`
                    FROM `cia00_component_schedule`
                    WHERE `cia00_component_schedule`.`PROFILE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PROFILE_ID')).'" 
                    AND `cia00_component_schedule`.`PROFILE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PROFILE_ID')).'"
                    AND `cia00_component_schedule`.`PAGE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PAGE_ID')).'" 
                    AND `cia00_component_schedule`.`PAGE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PAGE_ID')).'" 
                    AND `cia00_component_schedule`.`ISACTIVE`="1"
                    ;';

                    //
                    // PAGE_DAYS
                    $tmp_SELECT_ARRAY[7] = 'SELECT `cia00_component_schedule_day`.`DAY_ID`,
                    ...
                    WHERE `cia00_component_schedule_day`.`PROFILE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PROFILE_ID')).'" 
                    AND `cia00_component_schedule_day`.`PROFILE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PROFILE_ID')).'"
                    AND `cia00_component_schedule_day`.`PAGE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PAGE_ID')).'" 
                    AND `cia00_component_schedule_day`.`PAGE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PAGE_ID')).'" 
                    AND `cia00_component_schedule_day`.`ISACTIVE`="1"
                    ORDER BY `cia00_component_schedule_day`.`DATE`
                    ;';

                    //
                    // PAGE_EVENTS
                    $tmp_SELECT_ARRAY[8] = 'SELECT `cia00_component_schedule_event`.`EVENT_ID`,
                   ...
                   `cia00_component_schedule_event`.`DAY_ID`,
                    ...
                    WHERE `cia00_component_schedule_event`.`PROFILE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PROFILE_ID')).'" 
                    AND `cia00_component_schedule_event`.`PAGE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PAGE_ID')).'" 
                    AND `cia00_component_schedule_event`.`ISACTIVE`="1"
                    ORDER BY `cia00_component_schedule_event`.`DATE`
                    ;';

                    //
                    // BULLET_LIST
                    $tmp_SELECT_ARRAY[9] = 'SELECT `cia00_component_bulletlist`.`BULLET_LIST_ID`,
                    `cia00_component_bulletlist`.`COMPONENT_ID`,
                    `cia00_component_bulletlist`.`PAGE_ID`,
                    `cia00_component_bulletlist`.`PROFILE_ID`,
                    `cia00_component_bulletlist`.`ISACTIVE`,
                    `cia00_component_bulletlist`.`ISORDERED`,
                    `cia00_component_bulletlist`.`BULLET_STYLE_ORDERED`,
                    `cia00_component_bulletlist`.`BULLET_STYLE_NOT_ORDERED`,
                    `cia00_component_bulletlist`.`CREATOR_ID`,
                    `cia00_component_bulletlist`.`CREATOR_IP`,
                    `cia00_component_bulletlist`.`CREATOR_SESSION_ID`,
                    `cia00_component_bulletlist`.`MODIFIER_ID`,
                    `cia00_component_bulletlist`.`MODIFIER_IP`,
                    `cia00_component_bulletlist`.`MODIFIER_SESSION_ID`,
                    `cia00_component_bulletlist`.`DATEMODIFIED`,
                    `cia00_component_bulletlist`.`DATECREATED`
                    FROM `cia00_component_bulletlist`
                    WHERE `cia00_component_bulletlist`.`PROFILE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PROFILE_ID')).'" 
                    AND `cia00_component_bulletlist`.`PROFILE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PROFILE_ID')).'"
                    AND `cia00_component_bulletlist`.`PAGE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PAGE_ID')).'" 
                    AND `cia00_component_bulletlist`.`PAGE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PAGE_ID')).'" 
                    AND `cia00_component_bulletlist`.`ISACTIVE`="1"
                    ;';

                    //
                    // BULLET_BULLETS
                    $tmp_SELECT_ARRAY[10] = 'SELECT `cia00_component_bulletlist_bullets`.`BULLET_ID`,
                    `cia00_component_bulletlist_bullets`.`ELEMENT_ID`,
                    `cia00_component_bulletlist_bullets`.`COMPONENT_ID`,
                    `cia00_component_bulletlist_bullets`.`PAGE_ID`,
                    `cia00_component_bulletlist_bullets`.`PROFILE_ID`,
                    `cia00_component_bulletlist_bullets`.`ISACTIVE`,
                    `cia00_component_bulletlist_bullets`.`DESCRIPTION_IS_BOLD`,
                    `cia00_component_bulletlist_bullets`.`SEQUENCE`,
                    `cia00_component_bulletlist_bullets`.`CREATOR_ID`,
                    `cia00_component_bulletlist_bullets`.`CREATOR_IP`,
                    `cia00_component_bulletlist_bullets`.`CREATOR_SESSION_ID`,
                    `cia00_component_bulletlist_bullets`.`MODIFIER_ID`,
                    `cia00_component_bulletlist_bullets`.`MODIFIER_IP`,
                    `cia00_component_bulletlist_bullets`.`MODIFIER_SESSION_ID`,
                    `cia00_component_bulletlist_bullets`.`DATEMODIFIED`,
                    `cia00_component_bulletlist_bullets`.`DATECREATED`
                    FROM `cia00_component_bulletlist_bullets`
                    WHERE `cia00_component_bulletlist_bullets`.`PROFILE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PROFILE_ID')).'" 
                    AND `cia00_component_bulletlist_bullets`.`PROFILE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PROFILE_ID')).'"
                    AND `cia00_component_bulletlist_bullets`.`PAGE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PAGE_ID')).'" 
                    AND `cia00_component_bulletlist_bullets`.`PAGE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PAGE_ID')).'" 
                    AND `cia00_component_bulletlist_bullets`.`ISACTIVE`="1"
                    ORDER BY `cia00_component_bulletlist_bullets`.`SEQUENCE` 
                    ;';

                    //
                    // PARAGRAPH
                    $tmp_SELECT_ARRAY[11] = 'SELECT `cia00_component_paragraph`.`PARAGRAPH_ID`,
                    `cia00_component_paragraph`.`ELEMENT_ID`,
                    `cia00_component_paragraph`.`COMPONENT_ID`,
                    `cia00_component_paragraph`.`PAGE_ID`,
                    `cia00_component_paragraph`.`PROFILE_ID`,
                    `cia00_component_paragraph`.`ISACTIVE`,
                    `cia00_component_paragraph`.`IS_BOLD`,
                    `cia00_component_paragraph`.`IS_BLOCKQUOTE`,
                    `cia00_component_paragraph`.`COPY_ALIGNMENT`,
                    `cia00_component_paragraph`.`CREATOR_ID`,
                    `cia00_component_paragraph`.`CREATOR_IP`,
                    `cia00_component_paragraph`.`CREATOR_SESSION_ID`,
                    `cia00_component_paragraph`.`MODIFIER_ID`,
                    `cia00_component_paragraph`.`MODIFIER_IP`,
                    `cia00_component_paragraph`.`MODIFIER_SESSION_ID`,
                    `cia00_component_paragraph`.`DATEMODIFIED`,
                    `cia00_component_paragraph`.`DATECREATED`
                    FROM `cia00_component_paragraph`
                    WHERE `cia00_component_paragraph`.`PROFILE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PROFILE_ID')).'" 
                    AND `cia00_component_paragraph`.`PROFILE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PROFILE_ID')).'"
                    AND `cia00_component_paragraph`.`PAGE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PAGE_ID')).'" 
                    AND `cia00_component_paragraph`.`PAGE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PAGE_ID')).'" 
                    AND `cia00_component_paragraph`.`ISACTIVE`="1"
                    ;';

                    //
                    // SUB_TITLE
                    $tmp_SELECT_ARRAY[12] = 'SELECT `cia00_component_subtitle`.`SUBTITLE_ID`,
                        `cia00_component_subtitle`.`ELEMENT_ID`,
                        `cia00_component_subtitle`.`COMPONENT_ID`,
                        `cia00_component_subtitle`.`PAGE_ID`,
                        `cia00_component_subtitle`.`PROFILE_ID`,
                        `cia00_component_subtitle`.`ISACTIVE`,
                        `cia00_component_subtitle`.`COPY_ALIGNMENT`,
                        `cia00_component_subtitle`.`CREATOR_ID`,
                        `cia00_component_subtitle`.`CREATOR_IP`,
                        `cia00_component_subtitle`.`CREATOR_SESSION_ID`,
                        `cia00_component_subtitle`.`MODIFIER_ID`,
                        `cia00_component_subtitle`.`MODIFIER_IP`,
                        `cia00_component_subtitle`.`MODIFIER_SESSION_ID`,
                        `cia00_component_subtitle`.`DATEMODIFIED`,
                        `cia00_component_subtitle`.`DATECREATED`
                    FROM `cia00_component_subtitle`
                    WHERE `cia00_component_subtitle`.`PROFILE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PROFILE_ID')).'" 
                    AND `cia00_component_subtitle`.`PROFILE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PROFILE_ID')).'"
                    AND `cia00_component_subtitle`.`PAGE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PAGE_ID')).'" 
                    AND `cia00_component_subtitle`.`PAGE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PAGE_ID')).'" 
                    AND `cia00_component_subtitle`.`ISACTIVE`="1"
                    ;';
                ...
                case 'create_fullscrn_overlay_page':
                    ...
                    //
                    // QUERY CONSTRUCTION ::
                    self::$query = 'INSERT INTO `cia00_overlay_fullscrn_pages`
                    (`PAGE_ID`,
                    `PAGE_ID_CRC32`,
                    `PROFILE_ID`,
                    `PROFILE_ID_CRC32`,
                ...
                case 'get_obs_mini_profile_data':
                    ...
                    // QUERY CONSTRUCTION ::
                    $tmp_SELECT_ARRAY = array();
                    $tmp_SELECT_ARRAY[0] = 'SELECT `cia00_obs_clients`.`OBSCLIENT_ID`,
                        ...
                        `cia00_obs_clients`.`ISVISIBLE_FULLSCRN`,
                        `cia00_obs_clients`.`ISVISIBLE_MINI`,
                        `cia00_obs_clients`.`MINI_DISPLAY_MODE`,
                        `cia00_obs_clients`.`CURRENT_WALL_TIME`,
                        `cia00_obs_clients`.`CURRENT_LANG_PACK_FULLSCRN`,
                        `cia00_obs_clients`.`CURRENT_LANG_PACK_MINI`,
                        `cia00_obs_clients`.`LAST_CONTACT`,
                    ...
                    FROM `cia00_obs_clients` WHERE  `cia00_obs_clients`.`ISACTIVE`="1" 
                    AND `cia00_obs_clients`.`FULLSCRN_PROFILE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PROFILE_ID')).'";
                    ';
                    ...
                    $tmp_SELECT_ARRAY[1] = 'SELECT `cia00_overlay_mini_profile`.`PROFILE_ID`,
                        ...
                        `cia00_overlay_mini_profile`.`DATECREATED`
                        FROM `cia00_overlay_mini_profile` 
                        WHERE `cia00_overlay_mini_profile`.`PROFILE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PROFILE_ID')).'"
                        AND `cia00_overlay_mini_profile`.`PROFILE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PROFILE_ID')).'"
                        AND `cia00_overlay_mini_profile`.`ISACTIVE`="1";
                        ';

                    $tmp_SELECT_ARRAY[2] = 'SELECT `cia00_lang_packs`.`LANGPACK_ID`,
                        `cia00_lang_packs`.`LANG_ID`,
                        `cia00_lang_packs`.`NAME`,
                        `cia00_lang_packs`.`NATIVE_NAME`,
                        `cia00_lang_packs`.`NATIVE_NAME_BLOB`,
                ...
                case 'get_obs_fullscrn_profile_data':
                    ...
                    FROM `cia00_obs_clients` WHERE  `cia00_obs_clients`.`ISACTIVE`="1" 
                    AND 
                    (`cia00_obs_clients`.`FULLSCRN_PROFILE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PROFILE_ID')).'" 
                    OR `cia00_obs_clients`.`FULLSCRN_PROFILE_ID`="demo");
                    ';

                    $tmp_SELECT_ARRAY[1] = 'SELECT `cia00_overlay_fullscrn_profile`.`PROFILE_ID`,
                        `cia00_overlay_fullscrn_profile`.`ISACTIVE`,
                        `cia00_overlay_fullscrn_profile`.`PROFILE_NAME`,
                        `cia00_overlay_fullscrn_profile`.`PROFILE_NAME_BLOB`,
                        `cia00_overlay_fullscrn_profile`.`OPACITY`,
                        ...
                        `cia00_overlay_fullscrn_profile`.`DATECREATED` 
                        FROM `cia00_overlay_fullscrn_profile` 
                        WHERE `cia00_overlay_fullscrn_profile`.`PROFILE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PROFILE_ID')).'"
                        AND `cia00_overlay_fullscrn_profile`.`PROFILE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PROFILE_ID')).'"
                        AND `cia00_overlay_fullscrn_profile`.`ISACTIVE`="1";
                        ';
                    ...
                    $tmp_SELECT_ARRAY[3] = 'SELECT `cia00_overlay_fullscrn_pages`.`PAGE_ID`,
                        ...
                        `cia00_overlay_fullscrn_pages`.`DATECREATED`
                    FROM `cia00_overlay_fullscrn_pages` 
                    WHERE `cia00_overlay_fullscrn_pages`.`ISACTIVE`="1"
                    AND `cia00_overlay_fullscrn_pages`.`PROFILE_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PROFILE_ID')).'" 
                    AND `cia00_overlay_fullscrn_pages`.`PROFILE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PROFILE_ID')).'" 
                    ORDER BY `cia00_overlay_fullscrn_pages`.`SEQUENCE` ASC;
                    ';

                    $tmp_SELECT_ARRAY[4] = 'SELECT `cia00_colors_hex`.`COLOR_ID`,
                        `cia00_colors_hex`.`COLOR_APPLICATION_KEY`,
                        `cia00_colors_hex`.`COLOR_HEX`,
                        `cia00_colors_hex`.`ISACTIVE`,
                        `cia00_colors_hex`.`COLOR_NAME`,
                    ...
                    $tmp_SELECT_ARRAY[5] = 'SELECT `cia00_profile_lang_requests`.`REQUEST_ID`,
                        `cia00_profile_lang_requests`.`FULLSCRN_PROFILE_ID`,
                        `cia00_profile_lang_requests`.`MINI_PROFILE_ID`,
                        `cia00_profile_lang_requests`.`LANG_ID`,
                        `cia00_profile_lang_requests`.`ISACTIVE`,
                        ...
                        `cia00_profile_lang_requests`.`DATECREATED`
                    FROM `cia00_profile_lang_requests`
                    WHERE ((`cia00_profile_lang_requests`.`FULLSCRN_PROFILE_ID`= "'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PROFILE_ID')).'" 
                    AND `cia00_profile_lang_requests`.`FULLSCRN_PROFILE_ID_CRC32`= "'.crc32($oUser->retrieve_Form_Data('PROFILE_ID')).'" )
                    OR (`cia00_profile_lang_requests`.`MINI_PROFILE_ID`= "'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('PROFILE_ID')).'"
                    AND `cia00_profile_lang_requests`.`MINI_PROFILE_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('PROFILE_ID')).'" ))
                    AND `cia00_profile_lang_requests`.`ISACTIVE`="1" 
                    ORDER BY `cia00_profile_lang_requests`.`LANG_ID` DESC;
                    ';
                ...
                case 'obs_client_mini_display_mode':
                    ...
                    self::$query = 'UPDATE `cia00_obs_clients`
                    SET
                ...
                case 'create_fullscrn_overlay':
                    ...
                    // cia00_overlay_fullscrn_config
                    self::$query .= 'INSERT INTO `cia00_overlay_fullscrn_config`
                    (`CONFIG_ID`,
                    `PROFILE_ID`,
                    `PROFILE_ID_CRC32`,
                    `CREATOR_ID`,
                ...
                case 'obs_client_return_current_status':
                    ...
                    $tmp_SELECT_ARRAY[0] = 'SELECT `cia00_obs_clients`.`OBSCLIENT_ID`,
                        ...
                        `cia00_obs_clients`.`DATEMODIFIED`,
                        `cia00_obs_clients`.`DATECREATED`
                    FROM `cia00_obs_clients` WHERE `cia00_obs_clients`.`OBS_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('OBS_ID')).'" 
                                               AND `cia00_obs_clients`.`OBS_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('OBS_ID')).'" 
                                                LIMIT 1;';
                    ...
                    $tmp_SELECT_ARRAY[1] = 'SELECT `cia00_overlay_fullscrn_profile`.`PROFILE_ID`,
                        ...
                        ORDER BY `cia00_overlay_fullscrn_profile`.`DATECREATED` DESC;
                                        ';

                    $tmp_SELECT_ARRAY[2] = 'SELECT `cia00_overlay_mini_profile`.`PROFILE_ID`,
                        `cia00_overlay_mini_profile`.`ISACTIVE`,
                        `cia00_overlay_mini_profile`.`PROFILE_NAME`,
                        `cia00_overlay_mini_profile`.`PROFILE_NAME_BLOB`,
                        `cia00_overlay_mini_profile`.`OPACITY`,
                    ...
                    ORDER BY `cia00_overlay_mini_profile`.`DATECREATED` DESC;
                                        ';

                    $tmp_SELECT_ARRAY[3] = 'SELECT `cia00_lang_packs`.`LANGPACK_ID`,
                        `cia00_lang_packs`.`LANG_ID`,
                        `cia00_lang_packs`.`NAME`,
                        `cia00_lang_packs`.`NATIVE_NAME`,
                        `cia00_lang_packs`.`NATIVE_NAME_BLOB`,
                ...
                case 'get_obs_client_profile_data':
                    ...
                    $tmp_SELECT_ARRAY[0] = 'SELECT `cia00_obs_clients`.`OBSCLIENT_ID`,
                        ...
                        `cia00_obs_clients`.`DATEMODIFIED`,
                        `cia00_obs_clients`.`DATECREATED`
                    FROM `cia00_obs_clients` WHERE `cia00_obs_clients`.`OBSCLIENT_ID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('OBSCLIENT_ID')).'" 
                                               AND `cia00_obs_clients`.`ISACTIVE`="1" LIMIT 1;';
                    ...
                    */
                    ...
                    if($tmp_obs_id!=''){
                        ...
                        $tmp_SELECT_ARRAY[0] = 'SELECT `cia00_obs_clients`.`OBSCLIENT_ID`,
                            ...
                            `cia00_obs_clients`.`DATEMODIFIED`,
                            `cia00_obs_clients`.`DATECREATED`
                        FROM `cia00_obs_clients` WHERE `cia00_obs_clients`.`ISACTIVE`="1" AND 
                        `cia00_obs_clients`.`OBS_ID`="'.self::$mysqli->real_escape_string(strtolower($tmp_obs_id)).'" AND `cia00_obs_clients`.`OBS_ID_CRC32`="'.crc32(strtolower($tmp_obs_id)).'" LIMIT 1;';
                        ...
                        if($tmp_loop_size<1){
                            ...
                            * */
                            ...
                            //
                            // NEW OBS CLIENT
                            self::$query = 'INSERT INTO `cia00_obs_clients`
                            (`OBSCLIENT_ID`,
                            `OBSCLIENT_ID_CRC32`,
                            `OBS_ID`,
                            `OBS_ID_CRC32`,
                            ...
                            self::$query .= 'INSERT INTO `cia00_overlay_state`
                            (`STATE_ID`,
                            `OBSCLIENT_ID`,
                            `OBSCLIENT_ID_CRC32`,
                            `OBS_ID`,
    ...
    CREATE TABLE `sys_msg_queue` (
      ...
      `DATECREATED` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
                    ...
                    */
                    switch($oUser->msg_delivery_status){
                        case 'success':
                            ...
                            self::$query = 'UPDATE `cia00_sys_msg_queue` SET 
							`ISACTIVE`="0",
                ...
                case 'get_sys_msgs':
                    ...
                    if(3==2){
                        self::$query = 'SELECT `cia00_sys_messages`.`MSG_KEYID`,`cia00_sys_messages`.`ISACTIVE`,`cia00_sys_messages`.`LANGCODE`,`cia00_sys_messages`.`MSG_NAME`,`cia00_sys_messages`.`MSG_SUBJECT`,`cia00_sys_messages`.`MSG_HTML`,`cia00_sys_messages`.`MSG_TEXT`,`cia00_sys_messages`.`MSG_DESCRIPTION`,`cia00_sys_messages`.`DATEMODIFIED`,`cia00_sys_messages`.`DATECREATED` FROM `cia00_sys_messages` WHERE (`cia00_sys_messages`.`ISACTIVE`="1" OR `cia00_sys_messages`.`ISACTIVE`="3") AND `cia00_sys_messages`.`MSG_KEYID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('MSG_KEYID')).'" AND `cia00_sys_messages`.`MSG_KEYID_CRC32`="'.crc32($oUser->retrieve_Form_Data('MSG_KEYID')).'" LIMIT 1;';
                    }else{
                        self::$query = 'SELECT `cia00_sys_messages`.`MSG_KEYID`,`cia00_sys_messages`.`ISACTIVE`,`cia00_sys_messages`.`LANGCODE`,`cia00_sys_messages`.`MSG_NAME`,`cia00_sys_messages`.`MSG_SUBJECT`,`cia00_sys_messages`.`MSG_HTML`,`cia00_sys_messages`.`MSG_TEXT`,`cia00_sys_messages`.`MSG_DESCRIPTION`,`cia00_sys_messages`.`DATEMODIFIED`,`cia00_sys_messages`.`DATECREATED` FROM `cia00_sys_messages` WHERE `cia00_sys_messages`.`ISACTIVE`="1" OR `cia00_sys_messages`.`ISACTIVE`="3";';
                    }
...
CREATE TABLE `cia00_sys_msg_queue` (
  `MSG_SOURCEID` char(70) NOT NULL,
  `MSG_SOURCEID_CRC32` bigint(11) UNSIGNED NOT NULL,
  `MSG_KEYID` char(25) NOT NULL,
  `MSG_KEYID_CRC32` bigint(11) UNSIGNED NOT NULL,
  ...
  `DATECREATED` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
                    ...
                    */
                    self::$query = 'SELECT `cia00_sys_msg_queue`.`MSG_SOURCEID`,`cia00_sys_msg_queue`.`MSG_KEYID`,`cia00_sys_msg_queue`.`ISACTIVE`,`cia00_sys_msg_queue`.`LANGCODE`,`cia00_sys_msg_queue`.`EMAIL`,`cia00_sys_msg_queue`.`RECIPIENTNAME`,`cia00_sys_msg_queue`.`USERID`,`cia00_sys_msg_queue`.`ACTIVATION_KEY`,`cia00_sys_msg_queue`.`CONTACTID`,`cia00_sys_msg_queue`.`REQUESTID`,`cia00_sys_msg_queue`.`PWD_RESET`,`cia00_sys_msg_queue`.`DATECREATED` FROM `cia00_sys_msg_queue` WHERE `cia00_sys_msg_queue`.`ISACTIVE`="1" OR `cia00_sys_msg_queue`.`ISACTIVE`="3";';
                ...
                case 'get_unsub_suppression':
                    self::$query = 'SELECT `cia00_email_unsub`.`EMAIL` FROM `cia00_email_unsub`;';
                ...
                case 'accnt_activate_resend':
                    self::$query = 'SELECT `cia00_sys_msg_queue`.`MSG_SOURCEID`,
                        `cia00_sys_msg_queue`.`MSG_KEYID`,
                        `cia00_sys_msg_queue`.`ISACTIVE`,
                        `cia00_sys_msg_queue`.`LANGCODE`,
                        `cia00_sys_msg_queue`.`EMAIL`,
                        `cia00_sys_msg_queue`.`RECIPIENTNAME`,
                        `cia00_sys_msg_queue`.`USERID`,
                        `cia00_sys_msg_queue`.`ACTIVATION_KEY`,
                        `cia00_sys_msg_queue`.`CONTACTID`,
                        `cia00_sys_msg_queue`.`REQUESTID`,
                        `cia00_sys_msg_queue`.`PWD_RESET`,
                        `cia00_sys_msg_queue`.`SUBJECT_LINE`,
                        `cia00_sys_msg_queue`.`BODY_HTML`,
                        `cia00_sys_msg_queue`.`BODY_TEXT`,
                        `cia00_sys_msg_queue`.`ERROR_INFO`,
                        `cia00_sys_msg_queue`.`DATEMODIFIED`,
                        `cia00_sys_msg_queue`.`DATECREATED`
                    FROM `cia00_sys_msg_queue`
                    WHERE `cia00_sys_msg_queue`.`EMAIL`="'.self::$mysqli->real_escape_string(strtolower($oUser->retrieve_Form_Data('EMAIL'))).'" 
                         ORDER BY `cia00_sys_msg_queue`.`DATECREATED` DESC LIMIT 1;';
                    ...
                    if(self::$mysqli->error){
                        ...
                        if($tmp_loop_size==0){
                            ...
                            for ($usrcnt=0; $usrcnt < $tmp_loop_size; $usrcnt++) {
                                ...
                                self::$query = 'INSERT INTO `cia00_sys_msg_queue` (`MSG_SOURCEID`, `MSG_SOURCEID_CRC32`,`MSG_KEYID`,`MSG_KEYID_CRC32`,`LANGCODE`,`EMAIL`, `RECIPIENTNAME`, `USERID`, `ACTIVATION_KEY`,`DATEMODIFIED`) 
                ...
                case 'user_signin':
                    ...
                    // QUERY CONSTRUCTION ::
                    $tmp_SELECT_ARRAY = array();
                    $tmp_SELECT_ARRAY[0] = 'SELECT `cia00_users`.`USERID`,
                    `cia00_users`.`ISACTIVE`,
                    `cia00_users`.`USER_PERMISSIONS_ID`,
                    `cia00_users`.`FIRSTNAME`,
                    `cia00_users`.`LASTNAME`,
                    ...
                    `cia00_users`.`LANGCODE`,
                    `cia00_users`.`LASTLOGIN`,
                    INET6_NTOA(`cia00_users`.`LASTLOGIN_IP`) AS LASTLOGIN_IP,
                    `cia00_users`.`LOGIN_CNT`,
                    `cia00_users`.`IMAGE_NAME`,
                    `cia00_users`.`IMAGE_WIDTH`,
                    `cia00_users`.`IMAGE_HEIGHT`,
                    `cia00_users`.`ABOUT` FROM `cia00_users` 
                    WHERE `cia00_users`.`EMAIL`="'.self::$mysqli->real_escape_string(strtolower($oUser->retrieve_Form_Data('EMAIL'))).'" AND `cia00_users`.`EMAIL_CRC32`="'.crc32(strtolower($oUser->retrieve_Form_Data('EMAIL'))).'" LIMIT 1;';
                    ...
                    for ($usrcnt=0; $usrcnt < $tmp_loop_size; $usrcnt++) {
                        ...
                        if(password_verify($oUser->retrieve_Form_Data('PWDHASH'), $tmp_pwdhash)){
                            ...
                            if($tmp_isactive=="1" || $tmp_isactive=="4"){
                                ...
                                self::$query = 'UPDATE `cia00_users` SET `cia00_users`.`LASTLOGIN`="'.$ts.'",`cia00_users`.`LASTLOGIN_IP`= INET6_ATON("' . $_SERVER['REMOTE_ADDR'] . '"),`cia00_users`.`LOGIN_CNT`="'.$tmp_newlogincnt.'",`cia00_users`.`DATEMODIFIED`="'.$ts.'" WHERE `cia00_users`.`USERID`="'.$tmp_userid.'" AND `cia00_users`.`USERID_CRC32`="'.crc32($tmp_userid).'" LIMIT 1;';
                                self::$query .= 'DELETE from `cia00_sessions` where SESSIONID="'.session_id().'" AND SESSIONID_CRC32="'.crc32(session_id()).'" LIMIT 1;';
                                self::$query .= 'INSERT INTO `cia00_sessions` (`SESSIONID`,`SESSIONID_CRC32`,`USERID`,`USERID_CRC32`,`REMOTE_ADDR`,`DATEMODIFIED`) VALUES ("'.session_id().'","'.crc32(session_id()).'","'.$tmp_userid.'","'.crc32($tmp_userid).'", INET6_ATON("' . $_SERVER['REMOTE_ADDR'] . '"),"'.$ts.'");';
                ...
                case 'validate_session':
                    ...
                    self::$query = 'SELECT `cia00_sessions`.`SESSIONID`,`cia00_sessions`.`USERID` FROM `cia00_sessions` WHERE `cia00_sessions`.`SESSIONID`="'.session_id().'" AND `cia00_sessions`.`SESSIONID_CRC32`="'.crc32(session_id()).'" AND `cia00_sessions`.`USERID`="'.$oEnv->oSESSION_MGR->getSessionParam('USERID').'" AND  `cia00_sessions`.`USERID_CRC32`="'.crc32($oEnv->oSESSION_MGR->getSessionParam('USERID')).'" AND `cia00_sessions`.`REMOTE_ADDR` = INET6_ATON("'.$_SERVER['REMOTE_ADDR'].'") AND DATE_SUB(CURDATE(),'.$oEnv->getEnvParam('SESSION_EXPIRE').') <= `cia00_sessions`.`DATEMODIFIED` LIMIT 1;';
                    ...
                    if(self::$mysqli->error){
                        ...
                        switch($ROWCNT){
                            case 1:
                                ...
                                self::$query = 'UPDATE `cia00_sessions` SET `cia00_sessions`.`DATEMODIFIED`="'.$ts.'" WHERE `cia00_sessions`.`SESSIONID`="'.session_id().'" AND 
								`cia00_sessions`.`SESSIONID_CRC32`="'.crc32(session_id()).'" AND
								`cia00_sessions`.`USERID`="'.$oEnv->oSESSION_MGR->getSessionParam('USERID').'" AND 
								`cia00_sessions`.`USERID_CRC32`="'.crc32($oEnv->oSESSION_MGR->getSessionParam('USERID')).'" LIMIT 1;';
                ...
                case 'user_signin_old':
                    ...
                    self::$query = 'SELECT `cia00_users`.`USERID`,`cia00_users`.`ISACTIVE`,`cia00_users`.`USER_PERMISSIONS_ID`,`cia00_users`.`FIRSTNAME`,`cia00_users`.`LASTNAME`,`cia00_users`.`LOCALITY`,`cia00_users`.`EMAIL`,`cia00_users`.`PWDHASH`,`cia00_users`.`LANGCODE`,`cia00_users`.`LASTLOGIN`, INET6_NTOA(`cia00_users`.`LASTLOGIN_IP`) AS LASTLOGIN_IP,`cia00_users`.`LOGIN_CNT`,`cia00_users`.`IMAGE_NAME`,`cia00_users`.`IMAGE_WIDTH`,`cia00_users`.`IMAGE_HEIGHT`,`cia00_users`.`ABOUT` FROM `cia00_users` 
                    WHERE `cia00_users`.`EMAIL`="'.self::$mysqli->real_escape_string(strtolower($oUser->retrieve_Form_Data('EMAIL'))).'" AND `cia00_users`.`EMAIL_CRC32`="'.crc32(strtolower($oUser->retrieve_Form_Data('EMAIL'))).'" LIMIT 1;';
                        ...
                        for ($usrcnt=0; $usrcnt < $tmp_loop_size; $usrcnt++) {
                            if(password_verify($oUser->retrieve_Form_Data('PWDHASH'), self::$result_ARRAY[$usrcnt][8])){
                                ...
                                if(self::$result_ARRAY[$usrcnt][1]=="1" || self::$result_ARRAY[$usrcnt][1]=="4"){
                                    ...
                                    self::$query = 'UPDATE `cia00_users` SET `cia00_users`.`LASTLOGIN`="'.$ts.'",`cia00_users`.`LASTLOGIN_IP`= INET6_ATON("' . $_SERVER['REMOTE_ADDR'] . '"),`cia00_users`.`LOGIN_CNT`="'.$tmp_newlogincnt.'",`cia00_users`.`DATEMODIFIED`="'.$ts.'" WHERE `cia00_users`.`USERID`="'.self::$result_ARRAY[$usrcnt][0].'" AND `cia00_users`.`USERID_CRC32`="'.crc32(self::$result_ARRAY[$usrcnt][0]).'" LIMIT 1;';
                                    self::$query .= 'DELETE from `cia00_sessions` where SESSIONID="'.session_id().'" AND SESSIONID_CRC32="'.crc32(session_id()).'" LIMIT 1;';
                                    self::$query .= 'INSERT INTO `cia00_sessions` (`SESSIONID`,`SESSIONID_CRC32`,`USERID`,`USERID_CRC32`,`REMOTE_ADDR`,`DATEMODIFIED`) VALUES ("'.session_id().'","'.crc32(session_id()).'","'.self::$result_ARRAY[$usrcnt][0].'","'.crc32(self::$result_ARRAY[$usrcnt][0]).'", INET6_ATON("' . $_SERVER['REMOTE_ADDR'] . '"),"'.$ts.'");';
            ...
            self::$frm_input_ARRAY["LASTNAME"]*/
                ...
                case 'pwd_reset':
                    ...
                    self::$query = 'SELECT `cia00_users`.`USERID`,`cia00_users`.`FIRSTNAME` FROM `cia00_users` WHERE 
					`cia00_users`.`EMAIL`="'.self::$mysqli->real_escape_string(strtolower(trim($oUser->retrieve_Form_Data('EMAIL')))).'" AND 
					`cia00_users`.`EMAIL_CRC32`="'.crc32(strtolower(trim($oUser->retrieve_Form_Data('EMAIL')))).'";';
                    ...
                    switch($ROWCNT){
                        case 1:
                            ...
                            self::$query = 'INSERT INTO `cia00_sys_pswd_reset` (`REQUESTID`,`REQUESTID_CRC32`,`USERID`,`EMAIL`) VALUES ("'.$tmp_requestid.'","'.crc32($tmp_requestid).'","'.self::$result_ARRAY[0][0].'","'.self::$mysqli->real_escape_string(strtolower(trim($oUser->retrieve_Form_Data('EMAIL')))).'");';

                            self::$query .= 'INSERT INTO `cia00_sys_msg_queue` (`MSG_SOURCEID`,`MSG_SOURCEID_CRC32`,`MSG_KEYID`,`MSG_KEYID_CRC32`,`REQUESTID`,`PWD_RESET`,`EMAIL`,`RECIPIENTNAME`,`DATEMODIFIED`) VALUES ("'.$tmp_msgsourceid.'","'.crc32($tmp_msgsourceid).'","PASSWORD_RESET","'.crc32('PASSWORD_RESET').'","'.$tmp_requestid.'","1","'.self::$mysqli->real_escape_string(strtolower($oUser->retrieve_Form_Data('EMAIL'))).'","'.self::$mysqli->real_escape_string(self::$result_ARRAY[0][1]).'","'.$ts.'");';
      ...
      `DATECREATED` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
        ...
        self::$frm_input_ARRAY["REQUESTID"]
                        */
                        ...
                        switch(sizeof(self::$result_ARRAY)){
                            case 1:
                                ...
                                self::$query = 'UPDATE `cia00_users` SET `PWDHASH`="'.$tmp_pwdhash.'",`DATEMODIFIED`="'.$ts.'" 
                ...
                case 'contact_home':
                    ...
                    //
                    // BUILD QUERY
                    self::$query = 'INSERT INTO `cia00_log_contact_req` (`CONTACTID`, `CONTACTID_CRC32`, `FIRSTNAME`,`LASTNAME`,`EMAIL`,`MOBILENUMBER`,`MESSAGE`,`PHPSESSION_ID`,`LANGCODE`,`HTTP_USER_AGENT`,`REMOTE_ADDR`,`CHK_ASSIST_ACCNT_CREATION`,`CHK_ASSIST_OBS_INTEGRATE`,`DATECREATED`) VALUES 
					("'.$tmp_contactid.'",
					 "'.crc32($tmp_contactid).'",
                    ...
                    self::$query .= 'INSERT INTO `cia00_sys_msg_queue` (`MSG_SOURCEID`,`MSG_SOURCEID_CRC32`,`MSG_KEYID`,`MSG_KEYID_CRC32`,`EMAIL`,`RECIPIENTNAME`,`LANGCODE`,`DATEMODIFIED`) VALUES ("'.$tmp_msgsourceid_user.'","'.crc32($tmp_msgsourceid_user).'","CONTACT_CONFIRM","'.crc32('CONTACT_CONFIRM').'","'.self::$mysqli->real_escape_string(strtolower($oUser->retrieve_Form_Data('EMAIL'))).'","'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('FIRSTNAME')).'","'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data("LANGCODE")).'","'.$ts.'");';
                    self::$query .= 'INSERT INTO `cia00_sys_msg_queue` (`MSG_SOURCEID`,`MSG_SOURCEID_CRC32`,`MSG_KEYID`,`MSG_KEYID_CRC32`,`EMAIL`,`RECIPIENTNAME`,`CONTACTID`,`DATEMODIFIED`) VALUES ("'.$tmp_msgsourceid_admin.'","'.crc32($tmp_msgsourceid_admin).'","ADMIN_CONTACT_CONFIRM","'.crc32('ADMIN_CONTACT_CONFIRM').'","'.self::$mysqli->real_escape_string($oEnv->getEnvParam('ADMIN_NOTIFICATIONS_EMAIL')).'","'.self::$mysqli->real_escape_string($oEnv->getEnvParam('ADMIN_NOTIFICATIONS_RECIPIENTNAME')).'","'.$tmp_contactid.'","'.$ts.'");';
                    self::$query .= 'INSERT INTO `cia00_sys_msg_queue` (`MSG_SOURCEID`,`MSG_SOURCEID_CRC32`,`MSG_KEYID`,`MSG_KEYID_CRC32`,`EMAIL`,`RECIPIENTNAME`,`CONTACTID`,`DATEMODIFIED`) VALUES ("'.$tmp_msgsourceid_sms.'","'.crc32($tmp_msgsourceid_sms).'","ADMIN_SMS_NOTIFICATION","'.crc32('ADMIN_SMS_NOTIFICATION').'","'.self::$mysqli->real_escape_string($oEnv->getEnvParam('SMS_NOTIFICATIONS_ENDPOINT')).'","'.self::$mysqli->real_escape_string($oEnv->getEnvParam('ADMIN_NOTIFICATIONS_RECIPIENTNAME')).'","'.$tmp_contactid.'","'.$ts.'");';
                ...
                case 'signup_main':
                    ...
                    self::$query = 'SELECT `cia00_users`.`EMAIL` FROM `cia00_users` WHERE `cia00_users`.`EMAIL`="'.self::$mysqli->real_escape_string(strtolower($oUser->retrieve_Form_Data("EMAIL"))).'" AND 
					`cia00_users`.`EMAIL_CRC32`="'.crc32(strtolower($oUser->retrieve_Form_Data("EMAIL"))).'";';
                    ...
                    if($ROWCNT>0){
                        ...
                        //
                        // PREPARE QUERY
                        self::$query = 'INSERT INTO `cia00_users` (`USERID`,`USERID_CRC32`,`FIRSTNAME`,`FIRSTNAME_BLOB`,`LASTNAME`,`LASTNAME_BLOB`,`LOCALITY`,`LOCALITY_BLOB`,`USER_PERMISSIONS_ID`,`EMAIL`,`EMAIL_CRC32`,`STREAM_MENTION`,`PWDHASH`,`LANGCODE`,`DATEMODIFIED`) VALUES 
						("'.$tmp_userid.'",
						"'.crc32($tmp_userid).'",
						"'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data("FIRSTNAME")).'",
						"'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data("FIRSTNAME")).'",
                        ...
                        self::$query .= 'INSERT INTO `cia00_users_activation` (`ACTIVATEKEY`, `ACTIVATEKEY_CRC32`,`USERID`,`USERID_CRC32`, `EMAIL`,`LANGCODE`, `DATEMODIFIED`) VALUES ("'.$tmp_activationkey.'", "'.crc32($tmp_activationkey).'","'.$tmp_userid.'", "'.crc32($tmp_userid).'", "'.self::$mysqli->real_escape_string(strtolower($oUser->retrieve_Form_Data("EMAIL"))).'", "'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data("LANGCODE")).'", "'.$ts.'");';

                        self::$query .= 'INSERT INTO `cia00_sys_msg_queue` (`MSG_SOURCEID`, `MSG_SOURCEID_CRC32`,`MSG_KEYID`,`MSG_KEYID_CRC32`,`LANGCODE`,`EMAIL`, `RECIPIENTNAME`, `USERID`, `ACTIVATION_KEY`,`DATEMODIFIED`) VALUES ("'.$tmp_message_sourceid.'","'.crc32($tmp_message_sourceid).'","ACCOUNT_ACTIVATE","'.crc32('ACCOUNT_ACTIVATE').'","'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data("LANGCODE")).'","'.self::$mysqli->real_escape_string(strtolower($oUser->retrieve_Form_Data("EMAIL"))).'","'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data("FIRSTNAME")).' '.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data("LASTNAME")).'","'.self::$mysqli->real_escape_string($tmp_userid).'","'.self::$mysqli->real_escape_string($tmp_activationkey).'","'.$ts.'");';
                        ...
                        if($tmp_piped!=''){
                            ...
                            foreach($tmp_pipe_ARRAY as $key => $val){
                                ...
                                self::$query .= 'INSERT INTO `cia00_translator_lang_id`
                                (`RELATION_ID`,
                                `USERID`,
                                `LANG_ID`,
                                `DATEMODIFIED`)
                ...
                case 'activate_account':
                    //
                    // SELECT ...
                    self::$query = 'SELECT `cia00_users_activation`.`ACTIVATEKEY`,`cia00_users_activation`.`ACTIVATEKEY_CRC32`,`cia00_users_activation`.`USERID`,`cia00_users_activation`.`USERID_CRC32`,`cia00_users_activation`.`ISACTIVE`,`cia00_users`.`USERID`,`cia00_users`.`ISACTIVE`,`cia00_users`.`EMAIL` FROM `cia00_users_activation` INNER JOIN `cia00_users` ON `cia00_users_activation`.`USERID` = `cia00_users`.`USERID` WHERE `cia00_users_activation`.`ACTIVATEKEY`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('ACTIVATEKEY')).'" AND `cia00_users_activation`.`ACTIVATEKEY_CRC32`="'.crc32($oUser->retrieve_Form_Data('ACTIVATEKEY')).'" AND `cia00_users_activation`.`USERID`="'.self::$mysqli->real_escape_string($oUser->retrieve_Form_Data('USERID')).'" AND `cia00_users_activation`.`USERID_CRC32`="'.crc32($oUser->retrieve_Form_Data('USERID')).'";';
                        ...
                        case 1:
                            ...
                            switch($row[0][self::$queryDescript_ARRAY['users_activation_ISACTIVE']]){
                                case 0:
                                    ...
                                    self::$query = 'UPDATE `cia00_users` SET `ISACTIVE`="4",`DATEMODIFIED`="'.$ts.'" 
									WHERE `USERID`="'.$row["USERID"].'" AND 
									`USERID_CRC32`="'.crc32($row["USERID"]).'" LIMIT 1;';

                                    self::$query .= 'UPDATE `cia00_users_activation` SET `ISACTIVE`="1",`DATEMODIFIED`="'.$ts.'" 
                    ...
                    break;
                case 'sync_LANGCODE':
                    self::$query = 'UPDATE `cia00_users` SET 
                ...
                break;
                case 'sys_lang_get':
                    self::$query = 'SELECT `cia00_sys_lang_type`.`LANG_ID`, `cia00_sys_lang_type`.`COUNTRY_ISO_CODE`, `cia00_sys_lang_type`.`COUNTRY_ISO_NAME`,
					`cia00_sys_lang_type`.`NATIVE_NAME_BLOB`, `cia00_sys_lang_type`.`RTL_FLAG`, `cia00_sys_lang_type`.`DATEMODIFIED`, `cia00_sys_lang_type`.`DATECREATED` FROM `cia00_sys_lang_type`;';

                    self::$query .= 'SELECT `cia00_sys_lang_elements`.`COUNTRY_ISO_CODE`, COUNT(*) AS `ELEMENTS` FROM `cia00_sys_lang_elements` GROUP BY `COUNTRY_ISO_CODE`;';
...
';
                ...
                case 'get_overlay_mgmt_state_for_XML':
                    ...
                    COMPONENT_SUBTITLE
                    PAGE_COMPONENTS [cia00_fullscrn_page_components]
                    LANG_ELEM_COMPONENTS [cia00_lang_elem_components]
                    */
                    ...
                    switch($tmp_select_profile){
                        case 'FULL_OVERLAY_XML':
                            ...
                            // cia00_overlay_fullscrn_pages
                            //
                            // FULLSCRN_PAGES
                            $tmp_SELECT_ARRAY[1] = 'SELECT `cia00_overlay_fullscrn_pages`.`PAGE_ID`,
                                `cia00_overlay_fullscrn_pages`.`PROFILE_ID`,
                                `cia00_overlay_fullscrn_pages`.`ISACTIVE`,
                                `cia00_overlay_fullscrn_pages`.`PAGE_NAME`,
                                `cia00_overlay_fullscrn_pages`.`PAGE_NAME_BLOB`,
                                `cia00_overlay_fullscrn_pages`.`BGCOLOR_HEX`,
                                `cia00_overlay_fullscrn_pages`.`COPYCOLOR_HEX`,
                                `cia00_overlay_fullscrn_pages`.`OPACITY`,
                                `cia00_overlay_fullscrn_pages`.`SEQUENCE`,
                                `cia00_overlay_fullscrn_pages`.`CREATOR_ID`,
                                `cia00_overlay_fullscrn_pages`.`CREATOR_IP_V6`,
                                ...
                                `cia00_overlay_fullscrn_pages`.`DATECREATED`
                            FROM `cia00_overlay_fullscrn_pages` 
                            WHERE `cia00_overlay_fullscrn_pages`.`PROFILE_ID` = "'.$tmp_PROFILE_ID.'"
                            AND `cia00_overlay_fullscrn_pages`.`PROFILE_ID_CRC32`= "'.crc32($tmp_PROFILE_ID).'"
                            AND `cia00_overlay_fullscrn_pages`.`ISACTIVE` ="1"
                            ORDER BY `cia00_overlay_fullscrn_pages`.`SEQUENCE` DESC;
                            ';

                            // cia00_overlay_fullscrn_profile
                            //
                            // FULLSCRN_PROFILES
                            $tmp_SELECT_ARRAY[2] = 'SELECT `cia00_overlay_fullscrn_profile`.`PROFILE_ID`,
                                `cia00_overlay_fullscrn_profile`.`ISACTIVE`,
                                `cia00_overlay_fullscrn_profile`.`PROFILE_NAME`,
                                `cia00_overlay_fullscrn_profile`.`PROFILE_NAME_BLOB`,
                                `cia00_overlay_fullscrn_profile`.`DIR_XML_ENDPOINT`,
                                `cia00_overlay_fullscrn_profile`.`HTTP_XML_ENDPOINT`,
                                `cia00_overlay_fullscrn_profile`.`OPACITY`,
                                `cia00_overlay_fullscrn_profile`.`BGCOLOR_HEX`,
                                `cia00_overlay_fullscrn_profile`.`CREATOR_ID`,
                                `cia00_overlay_fullscrn_profile`.`CREATOR_IP_V6`,
                                ...
                                `cia00_overlay_fullscrn_profile`.`DATECREATED`
                            FROM `cia00_overlay_fullscrn_profile`
                            WHERE `cia00_overlay_fullscrn_profile`.`PROFILE_ID` = "'.$tmp_PROFILE_ID.'"
                            AND `cia00_overlay_fullscrn_profile`.`PROFILE_ID_CRC32`= "'.crc32($tmp_PROFILE_ID).'"
                            LIMIT 1;
                            ';

                            //
                            // SYS_COLORS_HEX
                            $tmp_SELECT_ARRAY[3] = 'SELECT `cia00_colors_hex`.`COLOR_ID`,
                                `cia00_colors_hex`.`COLOR_APPLICATION_KEY`,
                                `cia00_colors_hex`.`COLOR_HEX`,
                                `cia00_colors_hex`.`ISACTIVE`,
                                `cia00_colors_hex`.`COLOR_NAME`,
                                `cia00_colors_hex`.`COLOR_NAME_BLOB`,
                                `cia00_colors_hex`.`CREATOR_ID`,
                                `cia00_colors_hex`.`CREATOR_IP_V6`,
                                `cia00_colors_hex`.`CREATOR_IP`,
                                `cia00_colors_hex`.`CREATOR_SESSION_ID`,
                                `cia00_colors_hex`.`MODIFIER_ID`,
                                `cia00_colors_hex`.`MODIFIER_IP_V6`,
                                `cia00_colors_hex`.`MODIFIER_IP`,
                                `cia00_colors_hex`.`MODIFIER_SESSION_ID`,
                                `cia00_colors_hex`.`DATEMODIFIED`,
                                `cia00_colors_hex`.`DATECREATED`
                            FROM `cia00_colors_hex` WHERE `cia00_colors_hex`.`ISACTIVE`="1";
                            ';

                            //
                            // COMPONENT_BULLETLIST
                            $tmp_SELECT_ARRAY[4] = 'SELECT `cia00_component_bulletlist`.`BULLET_LIST_ID`,
                                `cia00_component_bulletlist`.`COMPONENT_ID`,
                                `cia00_component_bulletlist`.`PAGE_ID`,
                                `cia00_component_bulletlist`.`PROFILE_ID`,
                                `cia00_component_bulletlist`.`ISACTIVE`,
                                ...
                                `cia00_component_bulletlist`.`BULLET_STYLE_NOT_ORDERED`,
                                `cia00_component_bulletlist`.`CREATOR_ID`,
                                `cia00_component_bulletlist`.`CREATOR_IP_V6`,
                                `cia00_component_bulletlist`.`CREATOR_IP`,
                                `cia00_component_bulletlist`.`CREATOR_SESSION_ID`,
                                `cia00_component_bulletlist`.`MODIFIER_ID`,
                                `cia00_component_bulletlist`.`MODIFIER_IP_V6`,
                                `cia00_component_bulletlist`.`MODIFIER_IP`,
                                `cia00_component_bulletlist`.`MODIFIER_SESSION_ID`,
                                `cia00_component_bulletlist`.`DATEMODIFIED`,
                                `cia00_component_bulletlist`.`DATECREATED`
                            FROM `cia00_component_bulletlist`
                            WHERE `cia00_component_bulletlist`.`PROFILE_ID` = "'.$tmp_PROFILE_ID.'"
                            AND `cia00_component_bulletlist`.`PROFILE_ID_CRC32`= "'.crc32($tmp_PROFILE_ID).'"
                            AND `cia00_component_bulletlist`.`ISACTIVE` = "1";
                            ';

                            //
                            // COMPONENT_BLIST_BULLETS
                            $tmp_SELECT_ARRAY[5] = 'SELECT `cia00_component_bulletlist_bullets`.`BULLET_ID`,
                                `cia00_component_bulletlist_bullets`.`ELEMENT_ID`,
                                `cia00_component_bulletlist_bullets`.`COMPONENT_ID`,
                                `cia00_component_bulletlist_bullets`.`PAGE_ID`,
                                `cia00_component_bulletlist_bullets`.`PROFILE_ID`,
                                ...
                                `cia00_component_bulletlist_bullets`.`SEQUENCE`,
                                `cia00_component_bulletlist_bullets`.`CREATOR_ID`,
                                `cia00_component_bulletlist_bullets`.`CREATOR_IP_V6`,
                                `cia00_component_bulletlist_bullets`.`CREATOR_IP`,
                                `cia00_component_bulletlist_bullets`.`CREATOR_SESSION_ID`,
                                `cia00_component_bulletlist_bullets`.`MODIFIER_ID`,
                                `cia00_component_bulletlist_bullets`.`MODIFIER_IP_V6`,
                                `cia00_component_bulletlist_bullets`.`MODIFIER_IP`,
                                `cia00_component_bulletlist_bullets`.`MODIFIER_SESSION_ID`,
                                `cia00_component_bulletlist_bullets`.`DATEMODIFIED`,
                                `cia00_component_bulletlist_bullets`.`DATECREATED`
                            FROM `cia00_component_bulletlist_bullets`
                            WHERE `cia00_component_bulletlist_bullets`.`PROFILE_ID` = "'.$tmp_PROFILE_ID.'"
                            AND `cia00_component_bulletlist_bullets`.`PROFILE_ID_CRC32`= "'.crc32($tmp_PROFILE_ID).'"
                            AND `cia00_component_bulletlist_bullets`.`ISACTIVE` = "1"
                            ;
                            ';
                            ...
                            //
                            // COMPONENT_PARAGRAPH
                            $tmp_SELECT_ARRAY[6] = 'SELECT `cia00_component_paragraph`.`PARAGRAPH_ID`,
                                `cia00_component_paragraph`.`ELEMENT_ID`,
                                `cia00_component_paragraph`.`COMPONENT_ID`,
                                `cia00_component_paragraph`.`PAGE_ID`,
                                `cia00_component_paragraph`.`PROFILE_ID`,
                                ...
                                `cia00_component_paragraph`.`COPY_ALIGNMENT`,
                                `cia00_component_paragraph`.`CREATOR_ID`,
                                `cia00_component_paragraph`.`CREATOR_IP_V6`,
                                `cia00_component_paragraph`.`CREATOR_IP`,
                                `cia00_component_paragraph`.`CREATOR_SESSION_ID`,
                                `cia00_component_paragraph`.`MODIFIER_ID`,
                                `cia00_component_paragraph`.`MODIFIER_IP_V6`,
                                `cia00_component_paragraph`.`MODIFIER_IP`,
                                `cia00_component_paragraph`.`MODIFIER_SESSION_ID`,
                                `cia00_component_paragraph`.`DATEMODIFIED`,
                                `cia00_component_paragraph`.`DATECREATED`
                            FROM `cia00_component_paragraph`
                            WHERE `cia00_component_paragraph`.`PROFILE_ID` = "'.$tmp_PROFILE_ID.'"
                            AND `cia00_component_paragraph`.`PROFILE_ID_CRC32`= "'.crc32($tmp_PROFILE_ID).'"
                            AND `cia00_component_paragraph`.`ISACTIVE` = "1"
                            ;
                            ';
                            ...
                            //
                            // COMPONENT_SCHEDULE
                            $tmp_SELECT_ARRAY[7] = 'SELECT `cia00_component_schedule`.`SCHEDULE_ID`,
                                `cia00_component_schedule`.`COMPONENT_ID`,
                                `cia00_component_schedule`.`PAGE_ID`,
                                `cia00_component_schedule`.`PROFILE_ID`,
                                `cia00_component_schedule`.`ISACTIVE`,
                                ...
                                `cia00_component_schedule`.`TIME_FORMAT`,
                                `cia00_component_schedule`.`CREATOR_ID`,
                                `cia00_component_schedule`.`CREATOR_IP_V6`,
                                `cia00_component_schedule`.`CREATOR_IP`,
                                `cia00_component_schedule`.`CREATOR_SESSION_ID`,
                                `cia00_component_schedule`.`MODIFIER_ID`,
                                `cia00_component_schedule`.`MODIFIER_IP_V6`,
                                `cia00_component_schedule`.`MODIFIER_IP`,
                                `cia00_component_schedule`.`MODIFIER_SESSION_ID`,
                                `cia00_component_schedule`.`DATEMODIFIED`,
                                `cia00_component_schedule`.`DATECREATED`
                            FROM `cia00_component_schedule`
                            WHERE `cia00_component_schedule`.`PROFILE_ID` = "'.$tmp_PROFILE_ID.'"
                            AND `cia00_component_schedule`.`PROFILE_ID_CRC32`= "'.crc32($tmp_PROFILE_ID).'";
                            ';

                            //
                            // COMPONENT_SCHED_DAY
                            $tmp_SELECT_ARRAY[8] = 'SELECT `cia00_component_schedule_day`.`DAY_ID`,
                                `cia00_component_schedule_day`.`COMPONENT_ID`,
                                `cia00_component_schedule_day`.`PAGE_ID`,
                                `cia00_component_schedule_day`.`PROFILE_ID`,
                                `cia00_component_schedule_day`.`DATE`,
                                ...
                                `cia00_component_schedule_day`.`DAY_YEAR`,
                                `cia00_component_schedule_day`.`CREATOR_ID`,
                                `cia00_component_schedule_day`.`CREATOR_IP_V6`,
                                `cia00_component_schedule_day`.`CREATOR_IP`,
                                `cia00_component_schedule_day`.`CREATOR_SESSION_ID`,
                                `cia00_component_schedule_day`.`MODIFIER_ID`,
                                `cia00_component_schedule_day`.`MODIFIER_IP_V6`,
                                `cia00_component_schedule_day`.`MODIFIER_IP`,
                                `cia00_component_schedule_day`.`MODIFIER_SESSION_ID`,
                                `cia00_component_schedule_day`.`DATEMODIFIED`,
                                `cia00_component_schedule_day`.`DATECREATED`
                            FROM `cia00_component_schedule_day`
                            WHERE `cia00_component_schedule_day`.`PROFILE_ID` = "'.$tmp_PROFILE_ID.'"
                            AND `cia00_component_schedule_day`.`PROFILE_ID_CRC32`= "'.crc32($tmp_PROFILE_ID).'";
                            ';

                            //
                            // COMPONENT_SCHED_EVENT
                            $tmp_SELECT_ARRAY[9] = 'SELECT `cia00_component_schedule_event`.`EVENT_ID`,
                                `cia00_component_schedule_event`.`ELEMENT_ID`,
                                `cia00_component_schedule_event`.`DAY_ID`,
                                `cia00_component_schedule_event`.`COMPONENT_ID`,
                                `cia00_component_schedule_event`.`PAGE_ID`,
                                ...
                                `cia00_component_schedule_event`.`ISACTIVE`,
                                `cia00_component_schedule_event`.`CREATOR_ID`,
                                `cia00_component_schedule_event`.`CREATOR_IP_V6`,
                                `cia00_component_schedule_event`.`CREATOR_IP`,
                                `cia00_component_schedule_event`.`CREATOR_SESSION_ID`,
                                `cia00_component_schedule_event`.`MODIFIER_ID`,
                                `cia00_component_schedule_event`.`MODIFIER_IP_V6`,
                                `cia00_component_schedule_event`.`MODIFIER_IP`,
                                `cia00_component_schedule_event`.`MODIFIER_SESSION_ID`,
                                `cia00_component_schedule_event`.`DATEMODIFIED`,
                                `cia00_component_schedule_event`.`DATECREATED`
                            FROM `cia00_component_schedule_event`
                            WHERE `cia00_component_schedule_event`.`PROFILE_ID` = "'.$tmp_PROFILE_ID.'"
                            AND `cia00_component_schedule_event`.`PROFILE_ID_CRC32`= "'.crc32($tmp_PROFILE_ID).'";
                            ';

                            //
                            // COMPONENT_SUBTITLE
                            $tmp_SELECT_ARRAY[10] = 'SELECT `cia00_component_subtitle`.`SUBTITLE_ID`,
                                `cia00_component_subtitle`.`ELEMENT_ID`,
                                `cia00_component_subtitle`.`COMPONENT_ID`,
                                `cia00_component_subtitle`.`PAGE_ID`,
                                `cia00_component_subtitle`.`PROFILE_ID`,
                                ...
                                `cia00_component_subtitle`.`COPY_ALIGNMENT`,
                                `cia00_component_subtitle`.`CREATOR_ID`,
                                `cia00_component_subtitle`.`CREATOR_IP_V6`,
                                `cia00_component_subtitle`.`CREATOR_IP`,
                                `cia00_component_subtitle`.`CREATOR_SESSION_ID`,
                                `cia00_component_subtitle`.`MODIFIER_ID`,
                                `cia00_component_subtitle`.`MODIFIER_IP_V6`,
                                `cia00_component_subtitle`.`MODIFIER_IP`,
                                `cia00_component_subtitle`.`MODIFIER_SESSION_ID`,
                                `cia00_component_subtitle`.`DATEMODIFIED`,
                                `cia00_component_subtitle`.`DATECREATED`
                            FROM `cia00_component_subtitle`
                            WHERE `cia00_component_subtitle`.`PROFILE_ID` = "'.$tmp_PROFILE_ID.'"
                            AND `cia00_component_subtitle`.`PROFILE_ID_CRC32`= "'.crc32($tmp_PROFILE_ID).'";
                            ';

                            //
                            // PAGE_COMPONENTS [cia00_fullscrn_page_components]
                            $tmp_SELECT_ARRAY[11] = 'SELECT `cia00_fullscrn_page_components`.`COMPONENT_ID`,
                                `cia00_fullscrn_page_components`.`PAGE_ID`,
                                `cia00_fullscrn_page_components`.`PROFILE_ID`,
                                `cia00_fullscrn_page_components`.`ISACTIVE`,
                                `cia00_fullscrn_page_components`.`COMPONENT_TYPE_KEY`,
                                ...
                                `cia00_fullscrn_page_components`.`PROFILE_SEQUENCE`,
                                `cia00_fullscrn_page_components`.`CREATOR_ID`,
                                `cia00_fullscrn_page_components`.`CREATOR_IP_V6`,
                                `cia00_fullscrn_page_components`.`CREATOR_IP`,
                                `cia00_fullscrn_page_components`.`CREATOR_SESSION_ID`,
                                `cia00_fullscrn_page_components`.`MODIFIER_ID`,
                                `cia00_fullscrn_page_components`.`MODIFIER_IP_V6`,
                                `cia00_fullscrn_page_components`.`MODIFIER_IP`,
                                `cia00_fullscrn_page_components`.`MODIFIER_SESSION_ID`,
                                `cia00_fullscrn_page_components`.`DATEMODIFIED`,
                                `cia00_fullscrn_page_components`.`DATECREATED`
                            FROM `cia00_fullscrn_page_components`
                            WHERE `cia00_fullscrn_page_components`.`PROFILE_ID` = "'.$tmp_PROFILE_ID.'"
                            AND `cia00_fullscrn_page_components`.`PROFILE_ID_CRC32`= "'.crc32($tmp_PROFILE_ID).'"
                            ORDER BY `cia00_fullscrn_page_components`.`PAGE_SEQUENCE` DESC;
                            ';

                            //
                            // LANG_ELEM_COMPONENTS [cia00_lang_elem_components]
                            $tmp_SELECT_ARRAY[12] = 'SELECT `cia00_lang_elem_components`.`ELEMENT_ID`,
                                `cia00_lang_elem_components`.`COPY_ID`,
                                `cia00_lang_elem_components`.`COMPONENT_ID`,
                                `cia00_lang_elem_components`.`PAGE_ID`,
                                `cia00_lang_elem_components`.`PROFILE_ID`,
                                ...
                                `cia00_lang_elem_components`.`DATECREATED`
                            FROM `cia00_lang_elem_components`
                            WHERE `cia00_lang_elem_components`.`PROFILE_ID` = "'.$tmp_PROFILE_ID.'"
                            AND `cia00_lang_elem_components`.`PROFILE_ID_CRC32`= "'.crc32($tmp_PROFILE_ID).'";
                            ';

                            // cia00_obs_clients
                            //
                            // OBS_CLIENTS
                            $tmp_SELECT_ARRAY[13] = 'SELECT `cia00_obs_clients`.`OBSCLIENT_ID`,
                                `cia00_obs_clients`.`OBS_ID`,
                                `cia00_obs_clients`.`ISACTIVE`,
                                `cia00_obs_clients`.`FULLSCRN_PROFILE_ID`,
                                `cia00_obs_clients`.`MINI_PROFILE_ID`,
                            ...
                            WHERE `cia00_obs_clients`.`OBSCLIENT_ID` = "'.$tmp_OBSCLIENT_ID.'"
                            LIMIT 1;
                            ';

                            //
                            // FULLSCRN_CONFIG
                            $tmp_SELECT_ARRAY[14] = 'SELECT `cia00_overlay_fullscrn_config`.`PAGE_ROTATION_SECS`,
                            ...
                            //
                            // OVERLAY_STATE
                            $tmp_SELECT_ARRAY[15] = 'SELECT `cia00_overlay_state`.`STATE_ID`,
                                `cia00_overlay_state`.`OBSCLIENT_ID`,
                                `cia00_overlay_state`.`OBS_ID`,
                                `cia00_overlay_state`.`INDEX_ENDPOINT`,
                                ...
                                `cia00_overlay_state`.`CREATOR_ID`,
                                `cia00_overlay_state`.`CREATOR_IP_V6`,
                                `cia00_overlay_state`.`CREATOR_IP`,
                                `cia00_overlay_state`.`CREATOR_SESSION_ID`,
                                `cia00_overlay_state`.`MODIFIER_ID`,
                                INET6_NTOA(`cia00_overlay_state`.`MODIFIER_IP_V6`) AS MODIFIER_IP_V6,
                                INET_NTOA(`cia00_overlay_state`.`MODIFIER_IP`) AS MODIFIER_IP,
                                `cia00_overlay_state`.`MODIFIER_SESSION_ID`,
                                `cia00_overlay_state`.`DATEMODIFIED`,
                                `cia00_overlay_state`.`DATECREATED`
                                FROM `cia00_overlay_state` WHERE `cia00_overlay_state`.`OBSCLIENT_ID`="'.$tmp_OBSCLIENT_ID.'"                     
                                LIMIT 1;
                            ';

                            //error_log('11396 - OVERLAY_STATE.FULLSCREEN_LASTMODIFIED fails...->'.$tmp_SELECT_ARRAY[15]);

                            //cia00_profile_lang_requests
                            // LANG_REQUESTS
                            $tmp_SELECT_ARRAY[16] = 'SELECT `cia00_profile_lang_requests`.`REQUEST_ID`,
                                `cia00_profile_lang_requests`.`FULLSCRN_PROFILE_ID`,
                                `cia00_profile_lang_requests`.`LANG_ID`,
                                `cia00_profile_lang_requests`.`ISACTIVE`,
                                `cia00_profile_lang_requests`.`CREATOR_ID`,
                                `cia00_profile_lang_requests`.`CREATOR_IP_V6`,
                                `cia00_profile_lang_requests`.`CREATOR_IP`,
                                `cia00_profile_lang_requests`.`CREATOR_SESSION_ID`,
                                `cia00_profile_lang_requests`.`MODIFIER_ID`,
                                `cia00_profile_lang_requests`.`MODIFIER_IP_V6`,
                                `cia00_profile_lang_requests`.`MODIFIER_IP`,
                                `cia00_profile_lang_requests`.`MODIFIER_SESSION_ID`,
                                `cia00_profile_lang_requests`.`DATEMODIFIED`,
                                `cia00_profile_lang_requests`.`DATECREATED`
                            FROM `cia00_profile_lang_requests`
                            WHERE `cia00_profile_lang_requests`.`FULLSCRN_PROFILE_ID` = "'.$tmp_PROFILE_ID.'"
                            AND `cia00_profile_lang_requests`.`FULLSCRN_PROFILE_ID_CRC32`= "'.crc32($tmp_PROFILE_ID).'";
                            ';

                            //
                            // MINI_PROFILES
                            $tmp_SELECT_ARRAY[17] = 'SELECT `cia00_overlay_mini_profile`.`PROFILE_ID`,
                                `cia00_overlay_mini_profile`.`ISACTIVE`,
                                `cia00_overlay_mini_profile`.`PROFILE_NAME`,
                                `cia00_overlay_mini_profile`.`PROFILE_NAME_BLOB`,
                                `cia00_overlay_mini_profile`.`DIR_XML_ENDPOINT`,
                                `cia00_overlay_mini_profile`.`HTTP_XML_ENDPOINT`,
                                `cia00_overlay_mini_profile`.`OPACITY`,
                                `cia00_overlay_mini_profile`.`BGCOLOR_HEX`,
                                `cia00_overlay_mini_profile`.`OVERLAY_HEIGHT`,
                                `cia00_overlay_mini_profile`.`OVERLAY_WIDTH`,
...
';
                    ...
                    $tmp_SELECT_ARRAY[6] = 'SELECT `cia00_lang_copy`.`COPY_ID`,
                        ...
                        `cia00_lang_copy`.`PAGE00_HEADER`,
                        `cia00_lang_copy`.`PAGE00_HEADER_BLOB`,
                        `cia00_lang_copy`.`PAGE00_TITLE`,
                        `cia00_lang_copy`.`PAGE00_TITLE_BLOB`,
                        `cia00_lang_copy`.`PAGE00_CODE_BLOB`,
                        `cia00_lang_copy`.`PAGE01_HEADER`,
                        `cia00_lang_copy`.`PAGE01_HEADER_BLOB`,
                        `cia00_lang_copy`.`PAGE01_TITLE`,
                        `cia00_lang_copy`.`PAGE01_TITLE_BLOB`,
                        `cia00_lang_copy`.`PAGE01_CODE_BLOB`,
                        `cia00_lang_copy`.`PAGE02_HEADER`,
                        `cia00_lang_copy`.`PAGE02_HEADER_BLOB`,
                        `cia00_lang_copy`.`PAGE02_TITLE`,
                        `cia00_lang_copy`.`PAGE02_TITLE_BLOB`,
                        `cia00_lang_copy`.`PAGE02_CODE_BLOB`,
                        `cia00_lang_copy`.`PAGE03_HEADER`,
                        `cia00_lang_copy`.`PAGE03_HEADER_BLOB`,
                        `cia00_lang_copy`.`PAGE03_TITLE`,
                        `cia00_lang_copy`.`PAGE03_TITLE_BLOB`,
                        `cia00_lang_copy`.`PAGE03_CODE_BLOB`,
                        `cia00_lang_copy`.`PAGE04_HEADER`,
                        `cia00_lang_copy`.`PAGE04_HEADER_BLOB`,
                        `cia00_lang_copy`.`PAGE04_TITLE`,
                        `cia00_lang_copy`.`PAGE04_TITLE_BLOB`,
                        `cia00_lang_copy`.`PAGE04_CODE_BLOB`,
                ...
                if($tmp_index_xml_status!== false){
                    ...
                    switch($type){
                        case 'full':
                            ...
                            //
                            // SYNC DB STATE
                            self::$query = 'UPDATE `cia00_overlay_state` SET 
                            ...
                            `DATEMODIFIED`="' . $ts . '" 
                            WHERE `cia00_overlay_state`.`OBSCLIENT_ID`="'.$oUser->retrieve_Form_Data('OBSCLIENT_ID').'"
                            AND `cia00_overlay_state`.`OBSCLIENT_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('OBSCLIENT_ID')).'"
                            LIMIT 1;';
                            ...
                            `MODIFIER_SESSION_ID` = "' . session_id() . '",
                            `DATEMODIFIED` = "' . $ts . '"
                            WHERE `cia00_obs_clients`.`OBSCLIENT_ID` = "'.$oUser->retrieve_Form_Data('OBSCLIENT_ID').'" 
                            AND `cia00_obs_clients`.`OBSCLIENT_ID_CRC32`="'.crc32($oUser->retrieve_Form_Data('OBSCLIENT_ID')).'"
                            LIMIT 1;
                            ';

                            self::$query .= 'UPDATE `cia00_overlay_fullscrn_profile`
                            SET
                        ...
                        case 'mini':
                            ...
                            self::$query .= 'UPDATE `cia00_overlay_mini_profile`
                            SET
                            `DIR_XML_ENDPOINT` = ' . $xml_output_ARRAY['PROFILE']['DIR_FILE_ENDPOINT'] . ',
                            `HTTP_XML_ENDPOINT` = ' . $xml_output_ARRAY['PROFILE']['HTTP_FILE_ENDPOINT'] . ',
                            `MODIFIER_ID` = "'.$tmp_userid.'",
