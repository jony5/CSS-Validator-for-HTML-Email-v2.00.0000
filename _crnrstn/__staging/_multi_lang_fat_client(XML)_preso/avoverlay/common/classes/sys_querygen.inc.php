        ...
        try{
            ...
            switch($processType){
                ...
                case 'SYNC_EVENTS_TO_DAY':
                    ...
                    /*
                     `cia00_component_schedule_event`.`EVENT_ID`,
...
';
            ...
            $tmp_SELECT_ARRAY[1] = 'SELECT `cia00_lang_elem_components`.`ELEMENT_ID`,
...
';
            ...
            $tmp_SELECT_ARRAY[2] = 'SELECT `cia00_sys_lang_elements`.`ELEMENT_ID`,
...
';
            ...
            // SITE_LANG_ELEMENTS
            $tmp_SELECT_ARRAY[4] = 'SELECT `cia00_sys_lang_elements`.`ELEMENT_ID`,
                        `cia00_sys_lang_elements`.`ELEMENT_REF_KEY`,
                        `cia00_sys_lang_elements`.`COUNTRY_ISO_CODE`,
                        `cia00_sys_lang_elements`.`ELEMENT_CONTENT`,
                        `cia00_sys_lang_elements`.`ELEMENT_CONTENT_BLOB`,
    ...
    private function generateSQL_new_language_translation_element(){
        ...
        try{
            ...
            if(self::$oUser->retrieve_Form_Data('COMPONENT_ID')!='' && self::$oUser->retrieve_Form_Data('ELEMENT_ID_TRANSLATION')!='' && self::$oUser->retrieve_Form_Data('COPY_ID')!='' && self::$oUser->retrieve_Form_Data('LANG_ID_TRANSLATOR')!='' && self::$oUser->retrieve_Form_Data('PROFILE_ID')!='' && self::$oUser->retrieve_Form_Data('PAGE_ID')!='') {
                ...
                self::$query .= 'INSERT INTO `cia00_lang_elem_components`
                (`ELEMENT_ID`,
                 `ELEMENT_ID_CRC32`,
                `COPY_HASH`,
                `COPY_ID`,
    ...
    private function generateSQL_new_translation_search_content(){
        ...
        try{
            ...
            if($tmp_component_id!='' && $tmp_page_id!='' && $tmp_profile_id!=''){
                ...
                self::$query .= 'INSERT INTO `cia00_lang_elem_search`
                (`SEARCH_ID`,
                `SEARCH_CONTENT`,
                `SEARCH_HASH`,
                `LANG_ID`,
