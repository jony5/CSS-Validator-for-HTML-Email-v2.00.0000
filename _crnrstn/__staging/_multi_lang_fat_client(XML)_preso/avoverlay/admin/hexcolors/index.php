...
$oDB_RESP = $oUSER->getSystemColors($tmp_serial_handle);
...
if($oCRNRSTN_ENV->oSESSION_MGR->getSessionParam("DEVICETYPE") == "m" || $oCRNRSTN_ENV->getEnvParam('MOBILE_ONLY') == true){
    ...
    <div data-role="page" id="myPage">
        ...
        <div role="main" class="ui-content">
            ...
            <div data-role="popup" id="popupAddNewColor" data-overlay-theme="a" data-theme="a" data-dismissible="false" style="max-width:400px;">
                ...
                <div role="main" class="ui-content">
                    <form action="#" method="post" name="post_proxy_form" id="post_proxy_form"  enctype="multipart/form-data" data-ajax="false">
                        ...
                        <label for="color_type" class="select">Select color type:</label>
                        <select name="color_type" id="color_type">
                            <option value="<?php echo $oCRNRSTN_ENV->paramTunnelEncrypt('BACKGROUND'); ?>" checked="checked">Solid Backgound</option>
                            <option value="<?php echo $oCRNRSTN_ENV->paramTunnelEncrypt('FONT'); ?>">Font</option>
                        </select>

                        <label for="color_name">Color Name:</label>
                        <input type="text" name="color_name" id="color_name" placeholder="White" value="">
                        <div class="frm_errstatus color_name_req" style="width:100%; display:none;">Required</div>
                        <div class="frm_errstatus color_name_invalid" style="width:100%; display:none;">Invalid color name</div>
                        <div class="cb_10"></div>

                        <label for="color_hex">Color Hex:</label>
                        <input type="text" name="color_hex" id="color_hex" placeholder="#FFFFFF" value="">
                        <div class="frm_errstatus color_hex_req" style="width:100%; display:none;">Required</div>
                        <div class="frm_errstatus color_hex_invalid" style="width:100%; display:none;">Invalid hex color</div>
                        <div class="cb_10"></div>

                        <input type="hidden" id="postid" name="postid" value="sys_add_new_color">
            ...
            <script type="application/javascript" language="javascript">
                $( "#post_proxy_form" ).submit(function( event ) {
                    //
                    // VALIDATE FORM
                    return validateForm('sys_add_new_color');
                });

            </script>

            <h2 style=" padding-bottom:0px; margin-bottom:0px;">Color Management</h2>
            <div class="cb_10"></div>
            <a href="#popupAddNewColor" data-rel="popup" data-transition="slideup">new</a>
            ...
            for($iii=0; $iii<$tmp_loop_size; $iii++){
                ...
                switch($tmp_color_type){
                    case 'BACKGROUND':
                        $tmp_color_type = "Background";
                    break;
                    case 'FONT':
                        $tmp_color_type = "Font";
                    break;
                ...
                echo '<li>'.$tmp_color_name.' ('.$tmp_color_hex.') for '.$tmp_color_type.' CSS</li>';
