...
if($oCRNRSTN_ENV->oSESSION_MGR->getSessionParam("DEVICETYPE") == "m" || $oCRNRSTN_ENV->getEnvParam('MOBILE_ONLY') == true){
    ...
    <div data-role="page" id="myPage">
        ...
        <div role="main" class="ui-content">
            ...
            <div data-role="popup" id="popupAddNewUserType" data-overlay-theme="a" data-theme="a" data-dismissible="false" style="max-width:400px;">
                ...
                <div role="main" class="ui-content">
                    <form action="#" method="post" name="post_proxy_form" id="post_proxy_form"  enctype="multipart/form-data" data-ajax="false">
                        ...
                        <label for="user_permissions_id">User Permissions ID:</label>
                        <input type="text" name="user_permissions_id" id="user_permissions_id" placeholder="420" value="">
                        <div class="frm_errstatus user_permissions_id_req" style="width:100%; display:none;">Required</div>
                        <div class="frm_errstatus user_permissions_id_invalid" style="width:100%; display:none;">Invalid ID</div>
                        <div class="cb_10"></div>

                        <label for="type_name">User Type Name:</label>
                        <input type="text" name="type_name" id="type_name" placeholder="Translator" value="">
                        <div class="frm_errstatus type_name_req" style="width:100%; display:none;">Required</div>
                        <div class="frm_errstatus type_name_invalid" style="width:100%; display:none;">Invalid type name</div>
                        <div class="cb_10"></div>

                        <label id="add_paragraph_title_label" for="description" class="input">Description:</label>
                        <textarea cols="40" rows="12" name="description" id="description" placeholder="Enter description..."></textarea>
                        <div class="frm_errstatus description_req" style="width:100%; display:none;">Required</div>
                        <div class="frm_errstatus description_invalid" style="width:100%; display:none;">Invalid description content</div>

                        <input type="hidden" id="postid" name="postid" value="sys_add_new_user_type">
            ...
            <script type="application/javascript" language="javascript">
                $( "#post_proxy_form" ).submit(function( event ) {
                    //
                    // VALIDATE FORM
                    return validateForm('sys_add_new_user_type');
                });

            </script>

            <h2 style=" padding-bottom:0px; margin-bottom:0px;">User Type Management</h2>
            <div class="cb_10"></div>
            <a href="#popupAddNewUserType" data-rel="popup" data-transition="slideup">new</a>

            <h3>System User Types</h3>
