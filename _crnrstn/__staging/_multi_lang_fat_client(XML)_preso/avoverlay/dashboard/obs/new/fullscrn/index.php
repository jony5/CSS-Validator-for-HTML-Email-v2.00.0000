...
if($oCRNRSTN_ENV->oSESSION_MGR->getSessionParam("DEVICETYPE") == "m" || $oCRNRSTN_ENV->getEnvParam('MOBILE_ONLY') == true){
    ...
    <div data-role="page" id="myPage">
        ...
                <label for="bg_opacity">Background Opacity:<br>(where 1 = No transparency)</label>
                <input style="touch-action:none;" type="range" name="bg_opacity" id="bg_opacity" data-track-theme="b" data-highlight="true" data-theme="b" min="0" max="1" step=".1" value="0.8">
            </div>
            <div class="cb_20"></div>
