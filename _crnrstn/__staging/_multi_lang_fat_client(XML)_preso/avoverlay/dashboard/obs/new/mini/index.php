...
if($oCRNRSTN_ENV->oSESSION_MGR->getSessionParam("DEVICETYPE") == "m" || $oCRNRSTN_ENV->getEnvParam('MOBILE_ONLY') == true){
    ...
    <div data-role="page" id="myPage">
        ...
        <div role="main" class="ui-content">
            ...
            <h2 style=" padding-bottom:0px; margin-bottom:0px;">New Full Screen Overlay</h2>
            <div class="cb_10"></div>

            <form action="#" method="post" name="create_fullscrn_overlay" id="create_fullscrn_overlay"  enctype="multipart/form-data" data-ajax="false">

            <label for="fullscrn_name">Name</label>
            <input type="text" name="fullscrn_name" id="fullscrn_name" value="">
            <div class="frm_errstatus fullscrn_name_req" style="width:100%; display:none;">Required</div>
            <div class="frm_errstatus fullscrn_name_invalid" style="width:100%; display:none;">Invalid overlay name</div>
            <div class="cb_10"></div>

            <label for="bg_color">Color</label>
            <fieldset data-role="controlgroup">
                <input type="radio" name="bg_color" id="bg_color_a" value="#000000">
                <label for="bg_color_a">Black</label>
                <input type="radio" name="bg_color" id="bg_color_b" value="#0D66A8">
                <label for="bg_color_b">Blue</label>
                <input type="radio" name="bg_color" id="bg_color_c" value="#5E5E5E">
                <label for="bg_color_c">Grey</label>
                <input type="radio" name="bg_color" id="bg_color_c" value="#229435">
                <label for="bg_color_c">Green</label>
                <input type="radio" name="bg_color" id="bg_color_c" value="#FF2C21">
                <label for="bg_color_c">Red</label>
                <input type="radio" name="bg_color" id="bg_color_d" value="#FFFFFF" checked="checked">
                <label for="bg_color_d">White</label>
            </fieldset>
            <div class="cd_10"></div>

            <label for="bg_opacity">Opacity (1 = No transparency)</label>
            <input type="range" name="bg_opacity" id="bg_opacity" data-track-theme="b" data-theme="b" min="0" max="1" step=".1" value="0.8">

            <div class="cb_20"></div>
            <button class="ui-shadow ui-btn ui-corner-all" type="submit" id="submit">SAVE</button>
            <input type="hidden" name="postid" value="create_fullscrn_overlay">
            </form>

            <div class="cb_20"></div>

            <script type="application/javascript" language="javascript">
                $( "#create_fullscrn_overlay" ).submit(function( event ) {
                    //
                    // VALIDATE FORM
                    return validateForm('create_fullscrn_overlay');
                });
