	...
	<div role="main" class="ui-content">
		<h1>You have been unsubscribed!</h1>
      	...
      	<div class="ui-body ui-body-a ui-corner-all">
            <p>Thank you for updating your email status with us. <a href="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR'); ?>" target="_self" data-ajax="false">Return home.</a></p>
        </div>
        <div class="cb_20"></div>
