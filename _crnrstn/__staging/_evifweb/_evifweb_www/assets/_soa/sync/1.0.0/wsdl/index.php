...
$server->wsdl->addComplexType(
	...
	array(
        ...
        'SPECIALTY_TYPE' => array('name' => 'SPECIALTY_TYPE', 'type' => 'xsd:string'),
		'KIVOTOS_ID' => array('name' => 'KIVOTOS_ID', 'type' => 'xsd:string'),
		'CLIENT_ID' => array('name' => 'CLIENT_ID', 'type' => 'xsd:string'),
		'STREAM_ID' => array('name' => 'STREAM_ID', 'type' => 'xsd:string'),
		'I_FEED_STREAM_ID' => array('name' => 'I_FEED_STREAM_ID', 'type' => 'xsd:string'),
		...
		'STREAM_CONTENT' => array('name' => 'STREAM_CONTENT', 'type' => 'xsd:string'),
        'STREAM_MENTIONS_EID' => array('name' => 'STREAM_MENTIONS_EID', 'type' => 'xsd:string'),
		...
		'FILE_PATH_LARGE' => array('name' => 'FILE_PATH_LARGE', 'type' => 'xsd:string'),
        'FILE_PATH_MED' => array('name' => 'FILE_PATH_MED', 'type' => 'xsd:string'),
        'FILE_PATH_SMALL' => array('name' => 'FILE_PATH_SMALL', 'type' => 'xsd:string'),
		'FILE_SIZE' => array('name' => 'FILE_SIZE', 'type' => 'xsd:string'),
		'FILE_MD5' => array('name' => 'FILE_MD5', 'type' => 'xsd:string'),
		'FILE_SHA1' => array('name' => 'FILE_SHA1', 'type' => 'xsd:string'),
		...
		'FLAG_AS_REPLACED' => array('name' => 'FLAG_AS_REPLACED', 'type' => 'xsd:string'),
...
function saveAssetUpdate($soapRequest){
	$SERVICE_RESPONSE = '';
	...
	//
	// PROCESS SOAP REQUEST AND RETURN RESULT (SOAP)
	$SERVICE_RESPONSE = $oSERVICE_MGR->buildResponse('saveAssetUpdate',$soapRequest);
...
$server->register('saveAssetUpdate',            				// method name
    array('oUploadAssetInfo' => 'tns:oAsset'),					// input parameters
    array('return' => 'xsd:string'),							// output parameters
    'urn:saveAssetUpdatewsdl',                					// namespace
    'urn:saveAssetUpdatewsdl#saveAssetUpdate',					// soapaction
    'rpc',                                    					// style
    'encoded',                                					// use
    'Save details for extranet asset update.'					// documentation
);
