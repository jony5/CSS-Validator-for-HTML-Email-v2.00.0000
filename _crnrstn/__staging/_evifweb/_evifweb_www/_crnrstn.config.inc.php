...
$oCRNRSTN->initLogging('BLUEHOST_2018','EMAIL','EMAIL@DOMAIN.COM,j5@DOMAIN.com,email@DOMAIN.com');							// SYSTEM DEFAULT ERROR LOGGING
$oCRNRSTN->initLogging('BLUEHOST_WWW_2018','EMAIL','EMAIL@DOMAIN.COM,j5@DOMAIN.com,email@DOMAIN.com');
...
if(!$oCRNRSTN_ENV->isConfigured($oCRNRSTN)){
	...
	*/
	...
	$oCRNRSTN->defineEnvResource('BLUEHOST_2018', 'ADMIN_NOTIFICATIONS_EMAIL', 'email@DOMAIN.com');
	...
	$oCRNRSTN->defineEnvResource('BLUEHOST_2018', 'SYSTEM_MSG_FROM_EMAIL', 'email@DOMAIN.com');
	...
	$oCRNRSTN->defineEnvResource('BLUEHOST_WWW_2018', 'ADMIN_NOTIFICATIONS_EMAIL', 'email@DOMAIN.com');
	...
	$oCRNRSTN->defineEnvResource('BLUEHOST_WWW_2018', 'SYSTEM_MSG_FROM_EMAIL', 'email@DOMAIN.com');
	...
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'ROOT_PATH_CLIENT_HTTP_MSG', 'http://172.16.225.128/');
	...
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'ADMIN_NOTIFICATIONS_EMAIL', 'email@DOMAIN.com');
	...
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'SYSTEM_MSG_FROM_EMAIL', 'email@DOMAIN.com');
	...
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'ASSET_POST_ENDPOINT', 'http://172.16.225.128/evifweb/assets/upload/');
	...
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'WSDL_URI', 'http://172.16.225.128/evifweb/assets/_soa/sync/1.0.0/wsdl/index.php?wsdl');
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'ASSET_DLOAD_ENDPOINT', 'http://172.16.225.128/evifweb/assets/download/');
	$oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'ASSET_PREVIEW_ENDPOINT', 'http://172.16.225.128/evifweb/assets/preview/');
    ...
    $oCRNRSTN->defineEnvResource('LOCALHOST_MAC', 'EXTERNAL_URI_PROXY_PATH', '172.16.225.128/evifweb/resource/proxy/');
