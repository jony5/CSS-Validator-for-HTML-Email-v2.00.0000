...
#error_log("/services/ index.php (8) Value for DOCUMENT_ROOT: ".$oCRNRSTN_USR->get_resource('DOCUMENT_ROOT')." and _CRNRSTN_ENV_KEY :: ".$_SESSION['jRs72bd0'.'CRNRSTN'.crc32('_CRNRSTN_ENV_KEY')]);
