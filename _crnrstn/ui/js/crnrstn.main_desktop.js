...
// function wtime_update_() {
//
//     if (document.getElementById("crnrstn_wtime_'.$this->page_serial.'")) {
//
//         if (document.getElementById("crnrstn_wtime_src_'.$this->page_serial.'")) {
//
//             var time_shown = document.getElementById("crnrstn_wtime_src_'.$this->page_serial.'").innerHTML;
//             var time_chunks = time_shown.split(":");
//             var rtime_chunk = document.getElementById("crnrstn_rtime_src_'.$this->page_serial.'").innerHTML;
//             var millisec_chunks = rtime_chunk.split(".");
//             var hour, mins, secs;
//             var hour_copy = "";
//             var mins_copy = "";
//             var secs_copy = "";
...
//             //}
//
//             document.getElementById("crnrstn_wtime_src_'.$this->page_serial.'").innerHTML = hour + ":" + crnrstn_plz_'.$this->page_serial.'(mins) + ":" + crnrstn_plz_'.$this->page_serial.'(secs);
//
//             if (hour > 0) {
//
//                 hour_copy = hour + " hr";
//                 count_time_elem = count_time_elem + 1;
//
//                 if (hour > 1) {
//
...
//             if (secs > 0) {
//
//                 secs_copy = " " + secs + "." + millisec_chunks[1] + " secs";
//                 count_time_elem = count_time_elem + 1;
//
//             } else {
//
//                 secs_copy = " 0." + millisec_chunks[1] + " secs";
//                 count_time_elem = count_time_elem + 1;
//
//             }
//
//             document.getElementById("crnrstn_wtime_'.$this->page_serial.'").innerHTML = hour_copy + mins_copy + secs_copy;
//
//             //
//             // ADJUST HEIGHT
//             //crnrstn_adjust_height_'.$this->page_serial.'();
//
//         }
//
//     }
...
//
//
// function crnrstn_plz_'.$this->page_serial.'(digit){
//
//     var zpad = digit + \'\';
//     if (digit < 10) {
//         zpad = "0" + zpad;
