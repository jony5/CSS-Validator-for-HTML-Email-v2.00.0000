                    ...
                    <div class="crnrstn_footer_content_wrapper">
                        ...
                        <div class="crnrstn_meta_time_stats_wrapper">
                            ...
                            <div class="crnrstn_meta_time_stats_content">
                                ...
                                <div id="crnrstn_meta00_'.$this->page_serial.'" class="crnrstn_meta_time_stats">['.$this->oCRNRSTN_USR->get_micro_time().' '.date('T').'] [rtime '.$this->oCRNRSTN_USR->wall_time().' secs] [wtime <span id="crnrstn_wtime_'.$this->page_serial.'"></span>] <div class="crnrstn_meta_5_logo">'.$this->oCRNRSTN_USR->return_creative('5').'</div></div>
