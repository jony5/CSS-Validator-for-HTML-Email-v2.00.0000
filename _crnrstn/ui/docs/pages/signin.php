...
# $this->oCRNRSTN_USR->initializeFormHandling({CRNRSTN_FORM_HANDLE}, {TRANSPORT_PROTOCOL});
...
$err_uri = 'l=e';
$success_uri = 'l=s';
$this->oCRNRSTN_USR->addValidationRedirect('crnrstn_signin_flagship', '*', '*', $err_uri, $success_uri);
...
# $this->oCRNRSTN_USR->addHiddenFormInputParamListener({CRNRSTN_FORM_HANDLE}, {HTML_DOM_FORM_INPUT_NAME}, {HTML_DOM_FORM_INPUT_ID <-notrequired}, {IS_REQUIRED}, {DEFAULT_VALUE <-notrequired});
$this->oCRNRSTN_USR->addHiddenFormInputParamListener('crnrstn_signin_flagship', 'crnrstn_country_iso_code', 'crnrstn_country_iso_code', true, $this->oCRNRSTN_USR->country_iso_code);
$this->oCRNRSTN_USR->addHiddenFormInputParamListener('crnrstn_signin_flagship', 'crnrstn_php_sessionid', 'crnrstn_php_sessionid', true, session_id());
            ...
            <div class="crnrstn_section_outter_wrapper signin">
                <div id="crnrstn_signin_bdr01_' . $this->page_serial . '"  class="crnrstn_section_inner_wrapper signin">
                    ...
                    <div class="crnrstn_signin_meta_time_stats_wrapper">
                        <div id="crnrstn_signin_meta00_'.$this->page_serial.'" class="crnrstn_signin_meta_time_stats">['.$this->oCRNRSTN_USR->get_micro_time().' '.date('T').'] [rtime '.$this->oCRNRSTN_USR->wall_time().' secs] [wtime <span id="crnrstn_wtime_'.$this->page_serial.'"></span>]</div>
